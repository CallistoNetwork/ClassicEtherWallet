<div class="row" ng-show="dexns_status === 3">
    ...
    <!--<div-->
    <!--class="card"-->
    <!--ng-repeat="_funcName in viewContracts track by $index">-->
    <!--<div class="card-body">-->
    <!--<button ng-click="updateViewState(_funcName)">-->
            ...
            <div class="col-sm-8">
                ...
                >
                    ...
                    <button
                            ...
                            ng-class="_function.stateMutability === 'view' ? 'btn-info' : 'btn-danger'"
