...
<head>
    ...
    <meta name="description"
          content="ClassicEtherWallet.com is a free, open-source, client-side interface for generating Ethereum wallets &amp; more. Interact with the Ethereum blockchain easily &amp; securely. Double-check the URL ( .com ) before unlocking your wallet.">
        ...
        <section class="container">
          ...
          <ul class="dropdown-menu" ng-show="dropdownNode">
            ...
            <li><a ng-click="customNodeModal.open(); dropdownNode = !dropdownNode;"> Add Custom Node </a></li>
                ...
                <span class="dropdown dropdown-background-node" ng-cloak>
