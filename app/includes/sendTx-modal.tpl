    ...
    <section class="modal-dialog">
        <section class="modal-content">
            ...
            <div class="modal-body">
                ...
                <table class="table text-center">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p><strong ng-show="tx.sendMode=='ether'" class="send-modal__addr">{{wallet.getChecksumAddressString()}}</strong>
                            </p>
                        </td>

                        <td ng-show="tx.sendMode=='ether'" class="mono">-><br/><h4 class="text-danger">{{tx.value}}
                            {{unitReadable}}</h4></td>
                        <td ng-show="tx.sendMode!=='ether'" class="mono">-><br/><h4 class="text-danger">{{tx.value}}
                            {{unitReadable}}</h4></td>
                        ...
                        <td ng-show="tx.sendMode!=='ether'">
                            <div class="addressIdenticon med" title="Address Indenticon"
                                 blockie-address="{{tokenTx.to}}" watch-var="tokenTx.to"></div>
                            <p><strong ng-show="tx.sendMode=='ether'" class="send-modal__addr">{{tokenTx.to}}</strong>
                            </p>
                        </td>
                ...
                <p> You are interacting with the <strong>{{ajaxReq.type}} chain</strong>, provided by <strong>{{ajaxReq.service}}</strong>.
                </p>
