...
const messageService = function () {
    ...
    this.saveMessages = function saveMessages() {
        ...
        globalFuncs.localStorage.setItem(LOCAL_STORAGE_KEY, JSON.stringify(messageSet_));
    ...
    this.handleGetLocalMessages = function handleGetLocalMessages() {
        ...
        try {
            ...
            const messages = messageSet(JSON.parse(globalFuncs.localStorage.getItem(LOCAL_STORAGE_KEY))
