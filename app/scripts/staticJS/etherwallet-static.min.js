                                    ...
                                    r =
                                        ...
                                        (o.getAttribute("href") &&
                                            o
                                                .getAttribute("href")
                                                .replace("#", ""));
                                document.getElementById(r) === t.modal &&
                                    t.open();
                            });
                    }),
    ...
    (t.prototype = {
        ...
        (e.prototype = {
            ...
            setupTypeNumber: function(t) {
                for (
                    var e = d.getBCHTypeNumber(this.typeNumber), o = 0;
                    18 > o;
                    o++
                ) {
                    var r = !t && 1 == (1 & (e >> o));
        ...
        (e.createData = function(t, o, n) {
            for (
                var a = r.getRSBlocks(t, o), s = new i(), l = 0;
                l < n.length;
                l++
            ) {
                var h = n[l];
            ...
            d = {
                ...
                getMask: function(t, e, o) {
                    switch (t) {
                        ...
                        case u.PATTERN100:
                            return (
                                0 == (Math.floor(e / 2) + Math.floor(o / 3)) % 2
                            );
                        case u.PATTERN101:
            ...
            return (
                (t.prototype.draw = function(t) {
                    function e(t, e) {
                        ...
                        for (var r in e)
                            e.hasOwnProperty(r) && o.setAttribute(r, e[r]);
                        return o;
                    }
                    var o = this._htOption,
                        r = this._el,
                        i = t.getModuleCount();
                    Math.floor(o.width / i),
                        Math.floor(o.height / i),
                        this.clear();
                    var n = e("svg", {
