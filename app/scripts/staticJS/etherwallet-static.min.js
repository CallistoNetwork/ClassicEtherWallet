!(function() {
  ...
  function r(t) {
    for (
      var o = t, r = t, i = Math.ceil(o / 2), n = o - i, a = [], s = 0;
      s < r;
      s++
    ) {
  ...
  (function(t) {
    ...
    var t = function(t, e) {
        (e = e || {}),
          ...
          (this.modal = "object" == typeof t ? t : document.querySelector(t)),
          (this.options = {}),
          (this.options.backdrop = "false" !== e.backdrop),
          (this.options.keyboard = "false" !== e.keyboard),
          (this.options.content = e.content),
          (this.duration = e.duration || 300),
          (this.options.duration =
            this.isIE && this.isIE < 10 ? 0 : this.duration),
      ...
      actions: function() {
        ...
        (this.open = function() {
          ...
          (this._open = function() {
            ...
            e &&
              (clearTimeout(e.getAttribute("data-timer")),
              this.removeClass(e, "in"),
              setTimeout(function() {
              ...
              clearTimeout(t.modal.getAttribute("data-timer")),
              (this.timer = setTimeout(function() {
                (t.modal.style.display = "block"),
                  ...
                  t.dismiss(),
                  t.keydown(),
                  t.addClass(document.body, "modal-open"),
                  t.addClass(t.modal, "in"),
                  t.modal.setAttribute("aria-hidden", !1);
              }, t.options.duration / 2)),
              this.modal.setAttribute("data-timer", t.timer);
          }),
          (this._close = function() {
            this.overlay && this.removeClass(this.overlay, "in"),
              this.removeClass(this.modal, "in"),
              this.modal.setAttribute("aria-hidden", !0),
              clearTimeout(t.modal.getAttribute("data-timer")),
              (this.timer = setTimeout(function() {
                t.removeClass(document.body, "modal-open"),
                  t.resize(),
                  t.resetAdjustments(),
                  t.resetScrollbar(),
                  t.dismiss(),
          ...
          (this.createOverlay = function() {
            ...
            t.setAttribute("class", "modal-backdrop fade"),
              e
                ? (this.overlay = e)
                : ((this.overlay = t), document.body.appendChild(t));
          }),
          ...
          (this.trigger = function() {
            ...
            for (r; r < o; r++)
              e[r].addEventListener("click", function(e) {
                var o = e.target,
                  r =
                    (o.getAttribute("data-target") &&
                      o.getAttribute("data-target").replace("#", "")) ||
                    (o.getAttribute("href") &&
                      o.getAttribute("href").replace("#", ""));
          ...
          (this._resize = function() {
            ...
            null !== t &&
              /in/.test(t.className) &&
              ((t.style.height = e.h), (t.style.width = e.w));
          }),
          ...
          (this.dismiss = function() {
            function e(e) {
              ("modal" !== e.target.parentNode.getAttribute("data-dismiss") &&
                "modal" !== e.target.getAttribute("data-dismiss") &&
                e.target !== t.modal) ||
                (e.preventDefault(), t.close());
            }
            /in/.test(this.modal.className)
              ? this.modal.removeEventListener("click", e, !1)
              : this.modal.addEventListener("click", e, !1);
          }),
    ...
    for (i; i < r; i++) {
      var n = o[i],
        a = {};
      (a.keyboard = n.getAttribute("data-keyboard")),
        (a.backdrop = n.getAttribute("data-backdrop")),
        (a.duration = n.getAttribute("data-duration")),
        new t(n, a);
    }
    return t;
  });
...
!(function() {
  ...
  (t.prototype = {
    ...
    write: function(t) {
      for (var e = 0, o = this.parsedData.length; o > e; e++)
    ...
    (e.PAD0 = 236),
    (e.PAD1 = 17),
    (e.createData = function(t, o, n) {
      for (var a = r.getRSBlocks(t, o), s = new i(), l = 0; l < n.length; l++) {
        var h = n[l];
        s.put(h.mode, 4),
          s.put(h.getLength(), d.getLengthInBits(h.mode, t)),
          h.write(s);
      }
    ...
    (e.createBytes = function(t, e) {
      ...
      for (var y = new Array(v), _ = 0, c = 0; i > c; c++)
        for (var l = 0; l < e.length; l++)
          c < a[l].length && (y[_++] = a[l][c]);
      for (var c = 0; n > c; c++)
        for (var l = 0; l < e.length; l++)
          c < s[l].length && (y[_++] = s[l][c]);
      return y;
    });
  for (
    var l = {
      ...
      d = {
        ...
        getErrorCorrectPolynomial: function(t) {
          for (var e = new o([1], 0), r = 0; t > r; r++)
            e = e.multiply(new o([1, c.gexp(r)], 0));
          return e;
        },
  ...
  (o.prototype = {
    ...
    multiply: function(t) {
      for (
        ...
        for (var i = 0; i < t.getLength(); i++)
          e[r + i] ^= c.gexp(c.glog(this.get(r)) + c.glog(t.get(i)));
      return new o(e, 0);
    },
    mod: function(t) {
      if (this.getLength() - t.getLength() < 0) return this;
      for (
        var e = c.glog(this.get(0)) - c.glog(t.get(0)),
    ...
    (r.getRSBlocks = function(t, e) {
      ...
      for (var i = o.length / 3, n = [], a = 0; i > a; a++)
        for (
          var s = o[3 * a + 0], l = o[3 * a + 1], h = o[3 * a + 2], u = 0;
          s > u;
          u++
        )
          n.push(new r(l, h));
      ...
      : (function() {
        ...
        ? (function() {
            ...
            function e(t, e) {
              var o = this;
              if (
                ((o._fFail = e), (o._fSuccess = t), null === o._bSupportDataURI)
              ) {
                ...
                for (var h = 0; i > h; h++)
                  for (var u = 0; i > u; u++) {
                    var d = t.isDark(h, u),
                      c = u * n,
                      f = h * a;
                    (o.strokeStyle = d ? r.colorDark : r.colorLight),
                      (o.lineWidth = 1),
                      (o.fillStyle = d ? r.colorDark : r.colorLight),
                      o.fillRect(c, f, n, a),
                      o.strokeRect(
                        Math.floor(c) + 0.5,
                        Math.floor(f) + 0.5,
