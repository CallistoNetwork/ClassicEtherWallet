...
(function(factory) {
  ...
  var Modal = function(element, options) {
    // element is the trigger button / options.target is the modal
    options = options || {};
    this.isIE =
  ...
  var getWindowWidth = function() {
    var htmlRect = document.documentElement.getBoundingClientRect(),
      fullWindowWidth =
        window.innerWidth || htmlRect.right - Math.abs(htmlRect.left);
    ...
    actions: function() {
      ...
      (this.open = function() {
              ...
              var b = e.target,
                s =
                  (b.getAttribute("data-target") &&
                    b.getAttribute("data-target").replace("#", "")) ||
                  (b.getAttribute("href") &&
                    b.getAttribute("href").replace("#", ""));
        ...
        (this._resize = function() {
          var overlay =
              this.overlay || document.querySelector(".modal-backdrop"),
            dim = {
        ...
        (this.dismiss = function() {
          function dismissHandler(e) {
            if (
              e.target.parentNode.getAttribute("data-dismiss") === "modal" ||
        ...
        (this.adjustDialog = function() {
          this.modal.style.paddingLeft =
            !this.bodyIsOverflowing && this.modalIsOverflowing
        ...
        (this.checkScrollbar = function() {
          ...
          this.modalIsOverflowing =
            this.modal.scrollHeight > document.documentElement.clientHeight;
        ...
        (this.setScrollbar = function() {
          ...
          if (this.bodyIsOverflowing) {
            document.body.style.paddingRight =
              bodyPad + this.scrollbarWidth + "px";
          }
        }),
