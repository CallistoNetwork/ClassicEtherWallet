...
de.data = {
    ...
    x_PasswordDesc:
        "Dieses Passwort * verschlüsselt * deinen Privatschlüssel. Dieser hat nichts mit der Erstellung deines Privatschlüssels zu tun. **Du wirst das Passwort und deinen Privatschlüssel brauchen, um das Wallet öffnen zu können.**",
    x_ReadMore: "Weiter lesen",
    x_ReplaceTx: "Transaktion ersetzen",
    x_TransHash: "Transaktionshash",
    x_TXFee: "TX Gebühr",
    x_TxHash: "TX Hash",

    /* Check TX Status */
    NAV_CheckTxStatus: "TX Status überprüfen",
    ...
    GET_ConfButton: "Ich verstehe. Fortsetzen.",
    GEN_Label_5: "Speicher deinen `Private Key`. ",
    GEN_Unlock: "Entsperre dein Wallet um deine Adresse zu sehen.",
    GAS_PRICE_Desc:
    ...
    NONCE_Desc:
        'Die "nonce" ist die Nummer von Transactions die von der gegebenen Adresse gesendet wurden. Sie stellt sicher, dass Tansaktionen in der richtigen Reihenfolge & nur ein mal gesendet werden.',
    TXFEE_Desc:
    ...
    x_JsonDesc:
        "Dies ist die unverschlüsselte Version deines privaten Schlüssels im JSON-Format. Du benötigst daher kein Passwort, aber jeder, der über diese JSON-Datei verfügt, hat ohne Passwort Zugang zu deinem Wallet und dem darin enthaltenen Ether. ",
    ...
    x_PrintDesc:
        'ProTip: Klicke auf "Drucken" und sichere die Datei als PDF, auch wenn du keinen Drucker hast! ',
    x_PrintShort: "Drucken ",
    x_PrivKey: "Privater Schlüssel (unverschlüsselt) ",
    x_PrivKey2: "Privater Schlüssel ",
    x_PrivKeyDesc:
        "Dies ist die unverschlüsselte Textversion deines privaten Schlüssels, d. h. du benötigst kein Passwort. Wenn jemand über diesen unverschlüsselten privaten Schlüssel verfügt, hat er/sie ohne Passwort Zugang zu deinem Wallet. Es wird daher empfohlen, den privaten Schlüssel zu verschlüsseln. ",
    x_Save: "Sichern ",
    ...
    sidebar_DisplayOnTrezor: "Zeige Adresse auf TREZOR an",
    sidebar_DisplayOnLedger: "Zeige Adresse auf Ledger an",
    ...
    ADD_Radio_5_Path: "Wähle den HD derivation path ",
    ...
    ADD_Warning_1:
        'Du kannst unter dem "Wallet-Tab" eine Kontoadresse "beobachten", ohne den privaten Schlüssel hochzuladen. Du hast damit **keinen** Zugang zu diesem Wallet und kannst auch keinen Ether daraus versenden. ',
    ...
    /* Generate Wallets */
    GEN_desc:
        "Wenn du mehrere Wallets auf einmal erstellen möchtest, kannst du dies hier tun ",
    GEN_Label_1: "Gib ein starkes Passwort ein (mindestens 9 Zeichen) ",
    GEN_Placeholder_1:
        "BITTE VERGISS NICHT dieses Passwort an einem sicheren Ort zu notieren! ",
    GEN_SuccessMsg: "Erfolgreich! Dein Wallet wurde erzeugt. ",
    GEN_Label_2:
        "Sichere deine Keystore-Datei oder deinen privaten Schlüssel. Sichere auch dein Passwort! ",
    ...
    SENDModal_Content_4:
        "HINWEIS: Wenn du eine Fehlermeldung erhälst, musst du vermutlich deinen Ether-Saldo erhöhen, um die Gas-Kosten des Token-Versands zu bezahlen. Gas wird in Ether bezahlt. ",
    ...
    /* Send Transaction */
    TRANS_desc:
        'Wenn du Token senden willst, nutze bitte die "Sende Tokens" Funktion ',
    TRANS_warning:
        'Wenn du die "Nur ETH" oder "Nur ETC" Funktionen benutzt, erfolgt die Transaktion über einen Vertrag. Einige Dienste haben ein Problem damit diese Transaktionen zu empfangen. Mehr lesen. ',
    TRANS_advanced: "+Fortgeschritten: Daten hinzufügen ",
    TRANS_data: "Daten ",
    TRANS_gas: "Gas Limit ",
    TRANS_sendInfo:
        "Eine Standard Transaktion mit 21000 Gas kostet 0.000441 ETH. Wir zahlen einen minimal höheren Gaspreis von 0.000000021 ETH um zu garantieren, dass die Transaktion schnell bearbeitet wird. Wir erheben keine Transaktionsgebühren. ",

    /* Send Transaction Modals */
    TRANSModal_Title: '"Nur ETH" und "Nur ETC" Transaktionen ',
    TRANSModal_Content_0:
        "Ein Hinweis zu den verschiedenen Transaktionen und Angeboten ",
    TRANSModal_Content_1:
        "**ETH (Standard Transaktion): ** Dies erzeugt eine Standard Transaktion direkt von einer Adresse zu einer anderen. Diese nutzt standardmässig 21000 Gas. Es ist gut möglich, dass alle Transaktionen dieser Art auf der ETC Blockchain wiederholt werden (Replay Attacke). ",
    TRANSModal_Content_2:
        '**Nur ETH: ** Dies sendet die Transaktion so über [Timon Rapp\'s "replay protection contract" (wie von VB empfohlen)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/), dass sie nur auf der **ETH** Blockchain ausgeführt wird. ',
    TRANSModal_Content_3:
        '**Nur ETC: ** Dies sendet die Transaktion so über [Timon Rapp\'s "replay protection contract" (wie von VB empfohlen)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/), dass sie nur auf der **ETC** Blockchain ausgeführt wird. ',
    TRANSModal_Content_4:
        '**Coinbase & ShapeShift: ** Sende nur Standard Transaktionen. Wenn du die Transaktion über eine der "Nur" Funktionen versendest, musst du den Support kontaktieren um deinen Betrag oder eine Rückerstattung zu erhalten. [Du kannst auch Shapeshifts "split" Werkzeug ausprobieren.](https://split.shapeshift.io/) ',
    TRANSModal_Content_5:
        "**Kraken & Poloniex:** Keine Probleme bekannt. Nutzen, was dir lieber ist ",
    ...
    OFFLINE_Desc:
        "Offline Transaktionen können in drei Schritten erzeugt werden. Schritt 1 und 3 erledigst an einem Online Computer und Schritt 3 an einem Offline/abgeschirmten Computer. Dies stellt sicher, dass deine privaten Schlüssel nie ein mit dem Internet verbundenes Gerät berühren. ",
    ...
    OFFLINE_Step1_Label_2:
        'Hinweis: Dies ist die VON Adresse, nicht die AN Adresse. Die Nonce wird basierend auf dem Ursprungsaccount berechnet. Wenn du einen abgeschirmten Computer nutzt, wäre dies die Adresse deines "cold-storage". ',
    OFFLINE_Step2_Title:
        "Schritt 2: Transaktion generieren (Offline Computer) ",
    ...
    OFFLINE_Step2_Label_4b:
        "21000 ist das Standard Gas Limit. Wenn du Verträge oder Daten sendest, musst du diesen Wert eventuell anpassen. Alles ungenutzte Gas wird dir zurück gesendet. ",
    OFFLINE_Step2_Label_5: "Nonce ",
    OFFLINE_Step2_Label_5b:
        "Dies wurde dir in Schritt 1 an deinem Online Computer angezeigt. ",
    OFFLINE_Step2_Label_6: "Daten ",
    OFFLINE_Step2_Label_6b:
        "Dies ist optional. Daten werden meist in Transaktionen an Verträge verwendet. ",
    OFFLINE_Step2_Label_7: "Gib deine privaten Schlüssel ein. ",
    OFFLINE_Step3_Title:
        "Schritt 3: Transaktion senden/veröffentlichen (Online Computer) ",
    OFFLINE_Step3_Label_1:
        'Kopiere die signierte Transaktion aus Schritt 2 hier hinein und drücke "TRANSAKTION SENDEN". ',
    ...
    MYWAL_Content_2:
        "Stelle sicher, dass du **die private Key/JSON Datei und das Passwort** deines Wallets gespeichert hast, bevor du es löschst. ",
    MYWAL_Content_3:
        "Wenn du dieses Wallet in Zukunft mit MyEtherWallet CX verwenden willst, musst du es mittels der privaten Key/JSON Datei und deinem Passwort manuell wieder hinzufügen. ",

    /* View Wallet Details */
    VIEWWALLET_Subtitle:
        "Dies erlaubt dir den Download verschiedener Versionen deines privaten Schlüssel sowie das erneute Drucken deines Papier-Wallets. Es wird empfohlen, dies zu tun um [Deinen Account in Geth/Mist zu importieren.](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Zum Überprüfen deines Kontostands empfehlen wir, einen Blockchain Explorer wie [gastracker.io](https://gastracker.io/) (ETC) / [etherscan.io](https://etherscan.io/) (ETH) zu verwenden. ",
    ...
    /* Chrome Extension */
    CX_error_1:
        'Du hast keine Wallets gespeichert. Klicke ["Wallet hinzufügen"](/cx-wallet.html#add-wallet) um eines hinzuzufügen! ',
    ...
    NODE_Warning:
        "Deine Node braucht HTTPS um sie auf ClassicEtherWallet.com benutzen zu können. Du kannst dir die [ClassicEtherWallet Repo herunterladen ](https://github.com/kvhnuke/etherwallet/releases/latest) & es lokal laufen lassen um sich zu jeder Node verbinden zu können. Oder bekomme ein gratis SSL Zertifikat bei [LetsEncrypt](https://letsencrypt.org/)",
    ...
    ADD_Ledger_4:
        "Wenn in den Einstellungen kein Browser Support ist, update die Firmware: [Firmware >1.2](https://www.ledgerwallet.com/apps/manager) ",
    ADD_Ledger_0a:
        "Du musst dich zu ClassicEtherwallet über eine sichere Verbindung (SSL / HTTPS) verbinden, um dich verbinden zu können. ",
    ADD_Ledger_0b:
    ...
    ERROR_15:
        "Es sieht nicht so aus als würde ein Proposal mit dieser ID existieren oder es gab einen Fehler beim Lesen des Proposal. ",
    ERROR_16:
    ...
    ERROR_23:
        "Bitte gebe eine gültige URL ein. Falls du dich mit HTTPS verbindest, muss auch der Knoten mit HTTPS ausgestattet werden. ",
    ...
    ERROR_28:
        "**Du benötigst deine Keystore-Datei & das Passwort** (oder den privaten Schlüssel) um künftig auf dein Wallet zugreifen zu können. Bitte sichere diese Datei daher auf einem externen Medium! Es gibt KEINE Möglichkeit, ein Wallet wiederherzustellen, wenn du diese Datei und das Passwort nicht sicherst. Lies die [Hilfe-Seite](https://www.ClassicEtherWallet.com/#help) für weitere Informationen. ",
    ...
    GETH_InsufficientFunds:
        "Unzureichendes Guthaben für Gasverbrauch * Gaspreis + Wert ",
    ...
    TranslatorName_2:
        "[mawalu](https://www.ClassicEtherWallet.com/?gaslimit=21000&to=0xA6e9A24981aFB71f96C7330618139a7B34BCdEc3&value=1.0#send-transaction) · ",
    TranslatorAddr_2: "0xA6e9A24981aFB71f96C7330618139a7B34BCdEc3 ",
    /* Translator 2             : Insert Comments Here */
    TranslatorName_3:
        "[huhn_solo](https://www.ClassicEtherWallet.com/?gaslimit=21000&to=0x1DAd1765381460db9A44846cDfA6f74c65A06B77&value=1.0#send-transaction) · ",
    TranslatorAddr_3: "0x1DAd1765381460db9A44846cDfA6f74c65A06B77 ",
    /* Translator 3             : Insert Comments Here */
    TranslatorName_4:
        "[FelixA](https://www.ClassicEtherWallet.com/?gaslimit=21000&to=0xb6999051b0Bfad32E192e107181E0ac72bE7EE3D&value=1.0#send-transaction) · ",
    TranslatorAddr_4: "0xb6999051b0Bfad32E192e107181E0ac72bE7EE3D ",
    /* Translator 4             : Insert Comments Here */
    TranslatorName_5:
        "danielsun174 · ffidan61 · [u/Preisschild](https://www.ClassicEtherWallet.com/?gaslimit=21000&to=0x700Eb9142a0CC709fce80709cfbF5Ac25438c584&value=0.1#send-transaction) ",
    TranslatorAddr_5: "",
    ...
    HELP_Remind_Desc_1:
        "**Ethereum, ClassicEtherWallet.com & ClassicEtherWallet CX, sowie einige der verwendeten Javascript Bibliotheken, die wir verwenden, befinden sich noch in Entwicklung.** Zwar haben wir alles umfassend getestet und es wurden erfolgeich tausende Wallets von Menschen aus aller Welt kreiert, jedoch bestimmt immer eine gewisse Gefahr, dass etwas unerwartetes passiert und dein Ether verloren geht. Bitte investiere nicht mehr als du verlieren kannst, und sei immer vorsichtig. Sollte etwas schlimmes passieren, **können wir uns leider nicht verantwortlich für einen Verlust zeichnen**. ",
    HELP_Remind_Desc_2:
        'ClassicEtherWallet.com & MyEtherWallet CX sind keine "web wallets". Du erstellst keinen Account oder sendest uns Ether den wir halten. Alle Daten bleiben auf deinem Computer, bzw. Browser. Unser Auftrag ist es, dir das Erstellen, Speichern und Zugreifen auf deine Accounts zu vereinfachen, sowie dir eine simple Möglichkeit zur Interaktion mit der Blockchain zu bieten. ',
    HELP_Remind_Desc_3:
        "Falls du deinen privaten Schlüssel und Passwort nicht speicherst, gibt es keine Möglichkeit den Zugriff auf das Konto und die darauf befindlichen Mittel wieder herzustellen. Bitte erstelle Back-ups und speichere deine Zugriffsdaten an verschiedenen Orten &ndash; nicht nur deinem Computer! ",
    ...
    HELP_0_Desc_4:
        "Verifiziere, dass du Zugriff auf dein neues Wallet hast und alle nötigen Informationen korrekt gespeichert sind. ",
    ...
    HELP_1_Desc_2:
        'Geh zur "Wallet hinzufügen" Seite & wähle "Neues Wallet erstellen" aus. ',
    HELP_1_Desc_3:
        "Wähle ein starkes Passwort aus. Falls du glaubst, dass du es vergessen könntest, speichere es an einem sicheren Ort ab. Du benötigst das Passwort um Transaktionen zu tätigen. ",
    ...
    HELP_2a_Desc_2:
        "Speichere die Adresse. Du kannst sie für dich behalten oder mit anderen teilen. Auf diese Adresse können andere Ether an dich senden. ",
    HELP_2a_Desc_3:
        "Speiche verschiedene Versionen deines privaten Schlüssels. Teile ihn nicht mit jemand anderem. Dein privater Schlüssel ist notwendig, wenn du auf deinen Ether zugreifen willst, um eine Überweisung zu tätigen! Es gibt 3 Arten des privaten Schlüssels ",
    HELP_2a_Desc_4:
        "Speichere deine Adresse, die verschiedenen Versionen des privaten Schlüssels, sowie eine PDF deines Papier-Wallets in einem Ordner. Speichere diesen auf deinem Computer und einem USB-Stick. ",
    HELP_2a_Desc_5:
        "Drucke das Wallet falls du einen Drucker hast. Andernfalls, schreibe deinen privaten Schlüssel und die Adresse auf ein Blatt Papier. Lagere dieses an einem sicheren Ort, abseits von deinem Computer und dem USB-Stick. ",
    HELP_2a_Desc_6:
        "Bitte denk daran, dass du den Verlust des Schlüssels aufgrund des Verlusts oder Versagen deiner Festplatte, des USB-Sticks oder dem Papier, selbst verhindern musst. Erwäge daher auch Situationen wie ein Feuer oder eine Überflutung. ",

    HELP_2b_Title:
        "2b) How do I safely / offline / cold storage with ClassicEtherWallet? ",
    HELP_2b_Desc_1:
    ...
    HELP_3_Desc_3:
        'Navigate to the ClassicEtherWallet.com "View Wallet Info" page. ',
    HELP_3_Desc_4:
    ...
    HELP_3_Desc_7:
        "Your wallet information should show up. Find you account address, next to a colorful, circular icon. This icon visually represents your address. Be certain that the address is the address you have saved to your text document and is on your paper wallet. ",
    HELP_3_Desc_8:
    ...
    HELP_4CX_Title: "4) Wie kann ich Ether über ClassicEtherWallet CX senden? ",
    HELP_4CX_Desc_1:
        'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Sende Ether und Tokens" page. ',
    ...
    HELP_5_Title:
        "5) Wie kann ich ClassicEtherWallet.com offline/lokal starten? ",
    HELP_5_Desc_1:
        'You can run ClassicEtherWallet.com on your computer instead of from the GitHub servers. You can generate a wallet completely offline and send transactions from the "Offline Transaction" page. ',
    HELP_5_Desc_7:
        "ClassicEtherWallet.com is now running entirely on your computer. ",
    HELP_5_Desc_8:
        "In case you are not familiar, you need to keep the entire folder in order to run the website, not just `index.html`. Don't touch or move anything around in the folder. If you are storing a backup of the ClassicEtherWallet repo for the future, we recommend just storing the ZIP so you can be sure the folder contents stay intact. ",
    HELP_5_Desc_9:
        "As we are constantly updating ClassicEtherWallet.com, we recommend you periodically update your saved version of the repo. ",
    ...
    HELP_8_Desc_2:
        "If ClassicEtherWallet.com goes down, you would have to find another way (like geth or Ethereum Wallet / Mist) to do what we are doing. But you wouldn't have to \"get\" your Ether out of ClassicEtherWallet because it's not in ClassicEtherWallet. It's in whatever wallet your generated via our site. ",
    HELP_8_Desc_3:
    ...
    HELP_8CX_Desc_2:
        "That said, it is **very important** that you back up all your information for any new wallets generated with ClassicEtherWallet CX. That way if anything happens to ClassicEtherWallet CX or your computer, you still have all the information necessary to access your Ether. See the #2a for how to back up your wallets. ",
    HELP_8CX_Desc_3:
        "If for some reason ClassicEtherWallet CX disappears from the Chrome Store, you can find the source on Github and load it manually. See #5 above. ",
    ...
    HELP_12_Title:
        "12) How do I import a wallet created with ClassicEtherWallet into geth / Ethereum Wallet / Mist? ",
