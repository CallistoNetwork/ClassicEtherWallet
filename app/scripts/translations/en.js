...
en.data = {
    ...
    NAV_SendEther: "Send and Stake CLO & Tokens ",
    NAV_SendTokens: "Send Tokens ",
    NAV_SignMsg: "Sign Message ",
    NAV_Swap: "Swap ",
    NAV_ViewWallet: "View Wallet info only ",
    ...
    sidebar_StakingBalance: "Staking Balance",
    sidebar_Reward: "Reward",
    ...
    ADD_MetaMask: "Connect to MetaMask / ClassicMask",
    ...
    ADD_Radio_5_woTrezor: "(Jaxx, Metamask/ClassicMask, Exodus, imToken)",
    ADD_Radio_5_withTrezor:
        "(Jaxx, Metamask/ClassicMask, Exodus, imToken, TREZOR)",
    ...
    SEND_custom_dexns: "Add Custom Token by Token Symbol ",
    SEND_gas: "Gas ",
    ...
    ERROR_17:
        "Account you are sending from does not have enough funds. If sending tokens, you must have 0.01 {} in your account to cover the cost of gas. ", // 17
    ERROR_18:
