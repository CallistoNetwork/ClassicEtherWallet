...
hu.data = {
    ...
    x_JsonDesc:
        "Ez a titkosítotatlan, JSON formátumú változata a privát kulcsodnak. Ez azt jelenti, hogy nincs szükség jelszóra az eléréséhez, viszont ha bárki megtalálja a JSON fájlt, akkor hozzáférhet a tárcádhoz és az Etheredhez a jelszó ismerete nélkül. ",
    ...
    x_PrintDesc:
        "Profi Tipp: Kattints a nyomtatásra és mentsd el PDF formátumban, még abban az esetben is, ha nincs nyomtatód! ",
    x_PrintShort: "Nyomtatás ",
    x_PrivKey: "Privát Kulcs (titkosítatlan) ",
    x_PrivKey2: "Privát Kulcs ",
    x_PrivKeyDesc:
        "Ez a titkosítatlan szöveges változata a privát kulcsodnak, ami azt jelenti, hogy az eléréséhez nem szükséges jelszó. Ha valaki megtalálta a titkosítatlan privát kulcsodat jelszó nélkül is hozzáférhet a tárcádhoz. Ezért a titkosított változat ajánlott. ",
    x_Save: "Mentés ",
    ...
    /* Header */
    MEW_Warning_1:
        "Mindig ellenőrizd az URL-t mielőtt megpróbálod elérni a tárcádat vagy új tárcát hozol létre. Óvakodj az adathalász oldalalaktól! ",
    CX_Warning_1:
        "Győződj meg róla, hogy van **külső adatmentésed** minden tárcáról, amit itt tárolsz. Több dolog is történhet, ami adatvesztést eredményezhet a Chrome Bővítményben, többek között a Bővítmény törlése vagy újratelepítése. A bővítmény egyszerű módja annak, hogy elérd a tárcáidat, de **nem** annak, hogy elmentsd azokat. ",
    MEW_Tagline: "Nyílt forrású JavaScript-alapú, Kliens-oldali Ether Tárca ",
    CX_Tagline:
        "Nyílt forrású JavaScript-alapú, Kliens-oldali Ether Tárca Chrome Bővítmény ",

    /* Footer */
    FOOTER_1:
        "Egy nyílt forrású, javascript-alapú, kliens-oldali eszköz Ethereum Tárcák létrehozására és tranzakicók végrehajtására. ",
    ...
    ADD_Warning_1:
        'Bármelyik számlát hozzáadhatod "megfigyelésre" a tárcák lapon, anélkül, hogy felöltenél privát kulcsot. Ez **nem azt jelenti**, hogy van hozzáférésed ehhez a tárcához és azt sem, hogy tudsz Ethert küldeni vele. ',
    ...
    /* Generate Wallets */
    GEN_desc:
        "Ha több tárcát szeretnél egyszerre generálni, azt megteheted itt ",
    ...
    GEN_Label_2:
        "Mentsd el a Keystore fájlt vagy a Privát Kulcsot. Ne felejtsd el a fenti jelszót! ",
    ...
    SENDModal_Content_4:
        "JEGYZET: Ha hibával találkozol valószínűleg ethert kell küldened a számládra, hogy fedezni tudd a gas-költségét a token küldésének. A Gas etherben fizetendő. ",
    ...
    /* Send Transaction */
    TRANS_desc:
        "Ha Tokeneket akarsz küldeni, kérlek használd a Token Küldése oldalt ehelyett. ",
    TRANS_warning:
        'Ha a "Csak ETH" vagy a "Csak ETC" Funkciókat használod a küldés kontraktuson keresztül megy végbe. Néhány szolgáltatásnak problémái lehetnek az ilyen tranzakciók elfogadásával. Kattints és tudj meg többet. ',
    TRANS_advanced: "+Haladó: Több Adat ",
    TRANS_data: "Adat ",
    TRANS_gas: "Gas Limit ",
    TRANS_sendInfo:
        "Egy standard tranzakció 21000 gas-t használ, ami 0.000441 ETH-be fog kerülni. Mi 0.000000021 ETH-nél (a minimálisnál) enyhén magasabb gas árat használunk, annak biztosítása érdekében, hogy gyorsan ki legyen bányászva. Tranazkciós költséget nem számolunk fel. ",

    /* Send Transaction Modals */
    TRANSModal_Title: '"Csak ETH" és "Csak ETC" Tranzakciók ',
    TRANSModal_Content_0:
        "Egy jegyzet a különféle tranzakciókról és szolgáltatásokról ",
    TRANSModal_Content_1:
        "**ETH (Standard Tranzakció): ** Egy alapértelmezett tranzakciót generál közvetlenül az egyik címről a másikra. A gas alapértéke 21000. Valószínűsíthető, hogy minden ETH, ami ezzel a módszerrel lesz elküldve, végbemegy az ETC láncon is. ",
    TRANSModal_Content_2:
        "**Csak ETH: **  Ez a tranzakciótípus [Timon Rapp replay protection/visszajátszás elleni védelem kontraktusán keresztül küld (ahogy azt Vitalik Buterin adjánlotta)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) tehát a küldés csak az **ETH** láncon megy végbe. ",
    TRANSModal_Content_3:
        "**Csak ETC: ** Ez a tranzakciótípus [Timon Rapp replay protection/visszajátszás elleni védelem kontraktusán keresztül küld (ahogy azt Vitalik Buterin adjánlotta)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) tehát a küldés csak az **ETC** láncon megy végbe. ",
    ...
    TRANSModal_Content_5:
        "**Kraken & Poloniex:** Nincsenek ismert problémák. Használható bárhogyan. ",
    ...
    OFFLINE_Desc:
        "Az Offline tranzakció generálása három lépsében történik. Az első(1.) és a harmadik(3.) lépéseket online számítógépen kell végrehajtani, a második(2.) lépést pedig offline/airgap számítógépen. Ezzel meggyőződhetsz róla, hogy a privát kulcsod nem érintkezik internetre kötött eszközzel. ",
    ...
    OFFLINE_Step1_Label_2:
        "Jegyzet: Ez a FELADÓ címe, nem a FOGADÓÉ. A nonce a feladó számlájából generálódik. Ha airgap-elt számítógépet használsz, ez a cím a hidegtárcás számla címe legyen. ",
    ...
    OFFLINE_Step2_Label_3b:
        "Ez volt látható az online számítógépen az első lépésben. ",
    OFFLINE_Step2_Label_4: "Gas Limit ",
    OFFLINE_Step2_Label_4b:
        "21000 az alapértelmezett gas limit. Amikor kontraktust küldesz vagy adatot adsz hozzá ezeknek különbözőeknek kell lennie. A nem használt gas visszatérül hozzád. ",
    OFFLINE_Step2_Label_5: "Nonce ",
    OFFLINE_Step2_Label_5b:
        "Ez volt látható az online számítógépen az első lépésben. ",
    OFFLINE_Step2_Label_6: "Adat ",
    OFFLINE_Step2_Label_6b:
        "Ez választható. Az adat mező gyakran használt, amikor tranzakciót küldesz kontraktusokba. ",
    OFFLINE_Step2_Label_7:
        "Írd be / Válaszd ki a Privát Kulcsodat / JSON-fájlt. ",
    OFFLINE_Step3_Title: "Lépés 3: Küld / Közzétesz (Online Számítógép) ",
    OFFLINE_Step3_Label_1:
        'Illeszd be ide az aláírt tranzakciót a második lépésből (Lépés 2) és nyomd meg a "TRANZAKCIÓ KÜLDÉSE" gombot. ',
    ...
    MYWAL_Content_1:
        "Figyelmeztetés! Arra készülsz, hogy eltávolítod a tárcádat ",
    MYWAL_Content_2:
        "Győződj meg róla, hogy **elmentetted a privát kulcsodat és/vagy Keystore fájlodat a jelszóval együtt,** mielőtt törlöd őket. ",
    MYWAL_Content_3:
        "Ha használni akarod ezt a tárcát a MyEtherWallet CX-szel a jövőben, manuálisan újra hozzá kell majd adnod a privát kulcs/JSON-nal és jelszóval. ",

    /* View Wallet Details */
    VIEWWALLET_Subtitle:
        "Ez lehetővé teszi számodra, hogy különböző változatú privát kulcsokat tölts le és újranyomtasd a papírtárcádat.  Ezt megteheted úgy, hogy [importálod a számládat a Geth/Mist-be](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Ha ellenőrizni akarod a számládat, azt ajánljuk, hogy használj blokklánc explorert mint az [gastracker.io](https://gastracker.io/) (ETC) / [etherscan.io](https://etherscan.io/) (ETH). ",
    ...
    MNEM_2:
        "Egyetlen mnemonikus frázis egyszerre több tárcához / címhez ad hozzáférést. Válaszd ki a címet amelyiket most használni szeretnéd. ",
    MNEM_more: "További Címek ",
    MNEM_prev: "Előző Címek ",

    /* Chrome Extension */
    CX_error_1:
        'Nincsen mentett Tárcád. Kattints ["Tárca Hozzáadása"](/cx-wallet.html#add-wallet) ahhoz, hogy hozzáadj egyet! ',
    ...
    ERROR_15:
        "Úgy tűnik ezzel az ID-vel nem létezik javaslat, vagy hiba történt a javaslat beolvasása közben. ",
    ERROR_16:
    ...
    GETH_NonExistentAccount:
        "A Számla nem létezik vagy az egyenleg túl alacsony ",
    ...
    PARITY_AlreadyImported:
        "Egy azonos hash-sel rendelkező tranzakció már importálva volt.",
    PARITY_Old: "A tranzakciós nonce túl alacsony. Próbáld meg megnövelni.",
    PARITY_TooCheapToReplace:
        "Túl alacsony a tranzakciós díj. Van egy másik tranzakció is a sorban azonos nonce-szal. Próbáld meg megemelni adíjat vagy megnövelni a nonce-t.",
    PARITY_LimitReached:
        "Túl sok tranzakció van a sorodban, ezért ez a tranzakció nem lett feldolgozva.",
    PARITY_InsufficientGasPrice:
        "Túl alacsony a tranzakciós díj. Nem felel meg a node-od minimum díjának. Minimum: {}, ennyi lenne: {}. Próbáld meg megnövelni a díjat.",
    PARITY_InsufficientBalance:
        "Nincs elegendő egyenleg. A számlán amiről küldeni próbálsz nem elég az egyenleg. Szükséges: {} és van: {}.",
    PARITY_GasLimitExceeded:
        "A tranzakcó ára meghaladja a jelenlegi gas limitet. Limit: {}, ennyi lenne: {}.",
    ...
    TranslatorName_1:
        "[belpheg](https://www.myetherwallet.com/?gaslimit=21000&to=0xBF8C35176eAD29257834D5A1592ed50Adb0b6e4f&value=1.0#send-transaction) · ",
    TranslatorAddr_1: "0xBF8C35176eAD29257834D5A1592ed50Adb0b6e4f ",
    /* Translator 1             : email: zoltan.tapi@donamin.com */
    TranslatorName_2:
        "[bluqesh](https://www.myetherwallet.com/?gaslimit=21000&to=0x4270A331d14CcdB6FB941f3f5De9Cf01607Bff9F&value=1.0#send-transaction) ",
    ...
    HELP_Warning:
        "Ha **2015 december 31** előtt készítettél egy tárcát vagy töltötted le a repo-t, akkor ellenőrizd a tárcáidat és töltsd le a repo új verzióját. Kattints a részletekért. ",
    HELP_Desc:
        "Valamit hiányolsz? Egyéb kérdésed lenne? [Írj nekünk](mailto:support@myetherwallet.com), és nem csak választ fogsz kapni, de még ezt az oldalt is frissítjük, hogy másoknak is hasznosabb legyen. ",
    ...
    HELP_0_Desc_4:
        "Ellnőrizd, hogy van hozzáférésed az új tárcához, és helyesen mentettél le minden szükséges információt. ",
    ...
    HELP_1_Desc_2:
        'Menj a "Tárca hozzáadása" oldalra, és válaszd ki az "Új Tárca Létrehozása" opciót. ',
    HELP_1_Desc_3:
        "Írj be egy erős jelszót. Ha úgy gondolod, esetleg elfelejtheted, akkor ments le / írd le egy biztonságos helyre, mert szükséged lesz rá később, hogy tranzakciókat küldhess. ",
    ...
    HELP_2a_Desc_2:
        "Mentsd le a címet. Megtarthatod magadnak, vagy megoszthatod másokkal is, így ők is tudnak neked Ethert küldeni. ",
    HELP_2a_Desc_3:
        "Mentsd el több példányban a privát kulcsot, és ne oszd meg senkivel. Erre van ugyanis szükség, ha hozzá szeretnél férni az Etheredhez, és el szeretnéd küldeni. Három fajta privát kulcs van: ",
    HELP_2a_Desc_4:
        "Tedd a címed, a privát kulcsod egy változatát és a papírtárca PDF-et egy mappába. Ments ezt le a számítógépedre és egy USB pendrive-ra. ",
    HELP_2a_Desc_5:
        "Ha van nyomtatód, nyomtasd ki a papírtárcát. Ennek hiányában írd le a privát kulcsot és a címed egy darab papírra. Ezt a számítógépedtől és a pendrive-tól elkülönített, biztonságos helyen tárold. ",
    HELP_2a_Desc_6:
    ...
    HELP_2b_Desc_6:
        "Mentsd le a címet, és a privát kulcs különféle verzióit. Mentsd le a jelszót is, ha esetleg nem emlékeznél rá örökre. ",
    HELP_2b_Desc_7:
        "Ezeket a paírokat / pendriveoket egymástól fizikailag különböző helyeken tárold. ",
    HELP_2b_Desc_8:
        'Menj a "Tárca adatainak megtekintése" oldalra, majd írd be a privát kulcsot/jelszót, hogy le tudd ellenőrizni, hogy minden helyes. Győződj meg róla, hogy a címet is helyesen írtad le. ',

    HELP_3_Title:
        "3) Hogyan tudom ellenőrizni, hogy hozzáférek a tárcához?How do I verify I have access to my new wallet? ",
    HELP_3_Desc_1:
    ...
    HELP_3_Desc_3:
        'Menj a MyEtherWallet.com-on a "Tárca adatainak megtekintése" oldalra. ',
    HELP_3_Desc_4:
        "Válaszd ki a tárca fájlt -vagy- a privát kulcsot, és nyisd ki a tárcádat. Select your wallet file -or- your private key and unlock your wallet. ",
    HELP_3_Desc_5:
        "Ha a tárca titkosított, automatikusan megjelenik egy szövegdoboz. Ide írd be a jelszót. ",
    HELP_3_Desc_6: 'Kattints a "Tárca feloldása" gombra. ',
    HELP_3_Desc_7:
        "Ezután megjelennek a tárcádhoz kapcsolódó információk. A címedet a színes, kör alakú ikon mellett fogod megtalálni. Ez az ikon a címed képi reprezentációja. Bizonyosodj meg róla, hogy ez a cím megegyezik az általad lementett címmel, és azzal ami a papír tárcán is szerepel. ",
    HELP_3_Desc_8:
        "Ha egy nagyobb összeget szeretnél a tárolni, akkor azt javasoljuk, hogy előtte próbálj meg egy kisebb összeget küldeni az új tárcából. Ehhez küldj az új címedre 0.001 Etheret, nyisd ki a tárcát, és küldd tovább ezt a 0.001 Ethert egy másik címre. Így biztos lehetsz benne, hogy minden jól működik. ",

    HELP_4_Title:
        "4) Hogyan tudok Ethert küldeni az egyik tárcámból egy másikba? ",
    HELP_4_Desc_1:
    ...
    HELP_4_Desc_3:
        "Válaszd ki a tárca fájlt -vagy- a privát kulcsot, és nyisd ki a tárcádat. ",
    HELP_4_Desc_4:
        "Ha a tárca titkosított, automatikusan megjelenik egy szövegdoboz. Ide írd be a jelszót. ",
    HELP_4_Desc_5: 'Kattints a "Tárca feloldása" gombra. ',
    HELP_4_Desc_6:
        'Írd be a címet ahova küldeni szeretnél az "Erre a címre" mezőbe. ',
    HELP_4_Desc_7:
        'Írd be az összeget, amennyit küldeni szeretnél. Ha a teljes egyenleget át szeretnéd küldeni, akkor használhatod a "Teljes egyenleg küldése" gombot is. ',
    HELP_4_Desc_9: 'Kattints a "Tranzakció generálása" gombra. ',
    HELP_4_Desc_10:
        "Meg fog jelenni még néhány mező. Ezeket a böngésződ tölti ki, miközben legenerálja a tranzakciót. ",
    HELP_4_Desc_11:
        'Kattints az ezek alatt levő kék "Tranzakció küldése" gombra. ',
    HELP_4_Desc_12:
    ...
    HELP_4CX_Desc_1:
        'Első lépésként hozzá kell adj egy tárcát. Ha ez megvan, két lehetőséged van: a "GyorsKüldés" funkció a Chrome Bővítmény ikonon, vagy az "Ether & Tokenek küldése" oldal. ',
    ...
    HELP_5_Title:
        "5) Hogyan lehet a MyEtherWallet-et offline/lokálisan használni? ",
    HELP_5_Desc_1:
    ...
    HELP_5_Desc_7:
        "A MyEtherWallet.com most teljesen a te számítógépedről fut. ",
    HELP_5_Desc_8:
    ...
    HELP_5CX_Title:
        "5) Hogyan tudom ezt a kiegészítőt a repo-ból telepíteni a Chrome Store helyett? ",
    HELP_5CX_Desc_2: "Kattints a `chrome-extension-vX.X.X.X.zip`. ",
    HELP_5CX_Desc_3:
        "A Goole Chrome-ban menj a Beállításokba (a jobb fenti menüből). ",
    ...
    HELP_5CX_Desc_6:
        'Kattints a "Kicsomagolt bővítmények betöltése..." gombra. ',
    HELP_5CX_Desc_7:
        'Keresd meg az előző lépésekben letöltött és már kicsomagolt mappát. Klikelj az "OK"-ra. ',
    HELP_5CX_Desc_8:
        "A bővítmény meg kell jelenjen a többi bővítmény közt és a Chrome menüben. ",
