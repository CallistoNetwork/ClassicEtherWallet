...
ja.data = {
    ...
    tx_notFound_2:
        "もし今、処理を送出した直後であれば、１５秒待ってから「処理状況を確認」ボタンを再度押してください。",
    ...
    tx_foundInPending_1:
        "あなたの処理が、現在接続中のノードの処理待ちプールの中で見つかりました。",
    tx_foundInPending_2: "現在待機中です（発掘待ち）。",
    tx_foundInPending_3:
        "この処理を取り消す、あるいは置き換えることができます。下記のお財布をアンロックしてください。 ",
    tx_FoundOnChain: "処理が見つかりました",
    tx_FoundOnChain_1:
        "あなたの待機中の処理は発掘されてブロックチェーンに載りました。",
    tx_FoundOnChain_2:
    ...
    GEN_Help_2:
        "で自分の口座にアクセスしてください。" /* to access your account. */,
    GEN_Help_3:
        "自分のデバイスそのものが、自分のお財布です。" /* Your device * is * your wallet. */,
    ...
    GEN_Help_8:
        "ファイルをダウンロードしませんでしたか？" /* Not Downloading a File? */,
    ...
    GEN_Help_12:
        "MyEtherWalletの上でこれを使って自分のお財布をアンロックしてください（Mist, Geth, Parityや他のお財布クライアントも可）" /*Use it to unlock your wallet via MyEtherWallet (or Mist, Geth, Parity and other wallet clients.)
*/,
    GEN_Help_13:
        "自分のキーストアファイルのバックアップ作成方法" /*How to Back Up Your Keystore File */,
    GEN_Help_14:
        "これらの方式の違いは？" /*What are these Different Formats? */,
    GEN_Help_15:
    ...
    GEN_Help_18:
        "２番目のバックアップ作成のため" /*To have a secondary backup.*/,
    GEN_Help_19:
        "パスワードを忘れた場合には" /*In case you ever forget your password.*/,
    ...
    GAS_LIMIT_Desc:
        "ガスリミットは、自分の処理にかかる料金の額です。「使用料金」 = ガス価格 ＊ ガスリミット」で、自分の処理をブロックに配置するための料金に支払われます。 この数字を増やしても、自分の処理が早く発掘されることはありません。ETHの送出 = 「２１０００」。トークンの送出 = ~「２０００００」。" /*Gas limit is the amount of gas to send with your TX. `TX fee` = gas price * gas limit & is paid to miners for including your TX in a block. Increasing this number will not get your TX mined faster. Sending ETH = `21000`. Sending Tokens = ~`200000`.*/,
    NONCE_Desc:
        "そのnonceは、指定のアドレスから送出される処理の数です。処理が正しい順番で重複しないように確実にするためのものです。",
    TXFEE_Desc:
    ...
    x_JsonDesc:
        "これはパスワードが不要な暗号化されていないJSONフォーマットの秘密鍵です。この暗号化されていないJSONフォーマットの秘密鍵を使えば、誰でもパスワードを使わずに自分のお財布とEtherにアクセスできます。 ",
    ...
    x_Print: "お財布紙情報を印刷 ",
    x_PrintDesc:
        "助言: プリンターが接続されていなくても、「印刷」をクリックしてPDFで保存できます。 ",
    x_PrintShort: "印刷 ",
    x_PrivKey: "秘密鍵（未暗号化） ",
    x_PrivKey2: "秘密鍵 ",
    x_PrivKeyDesc:
        "これはパスワードが不要な暗号化されていない秘密鍵です。この暗号化されていない秘密鍵を使えば、誰でもパスワードなしで自分のお財布を使用できます。従って、暗号化された秘密鍵の利用をおすすめします。 ",
    x_Save: "保存する ",
    x_Trezor: "TREZOR ",
    x_TXT: "TXT ファイル (未暗号化) ",
    x_Wallet: "お財布 ",
    ...
    /* Header */
    MEW_Warning_1:
        "お財布を操作したり新しいお財布を作成する前に、必ずURLを確認してください。詐欺サイトに御注意ください！ ",
    CX_Warning_1:
        "必ずここに保管するすべてのお財布の「外部バックアップ」を作成してください。このChrome Extensionでは、再導入などで、データが保存されずの消失することが頻繁に起こります。このエクステンションは容易な操作を提供するのみで、「バックアップ」は行いません。 ",
    MEW_Tagline: "オープンソース JavaScript クライアントサイド Etherお財布 ",
    CX_Tagline:
        "オープンソース JavaScript クライアントサイド Etherお財布 Chrome Extension ",

    /* Footer */
    FOOTER_1:
        "イサーリアムお財布の作成とトランザクション実行のためのオープンソース、javascript、 クライアントサイドツール。 ",
    FOOTER_1b: "制作 ",
    FOOTER_2: "投げ銭に感謝致します！: ",
    ...
    /* Chrome Extension */
    CX_error_1:
        'お財布が保存されていません。["Add Wallet"](/cx-wallet.html#add-wallet)をクリックして追加してください。 ',
    ...
    ADD_Warning_1:
        "任意のアカウントを監視する目的で、秘密鍵をアップロードせずにお財布タブに追加することできます。これによってお財布の操作や、ETHERの移動が可能になるわけではありません。 ",
    ADD_Label_5: "アドレスを入力 ",
    ...
    MNEM_2:
        "ＨＤニーモニックの一つの文節で、複数のお財布やアドレスが操作可能です。操作したいアドレスを選択してください。 ",
    ...
    ADD_Ledger_2:
        "イサリアムアプリケーション（あるいはコントラクトアプリケーション）を開く　。 ",
    ADD_Ledger_3:
        "設定中で、ブラウザサポートが有効にされていることを確認してください。 ",
    ADD_Ledger_4:
        "設定にブラウザサポートが見つからなければ、[Firmware >1.2]を確認してください。(https://www.ledgerwallet.com/apps/manager) ",
    ADD_Ledger_0a:
        "セキュアコネクション（SSL)で再度MyEtherWalletを開いてください。 ",
    ADD_Ledger_0b:
    ...
    GEN_Label_4:
        "必要であれば、お財布紙情報、あるいはQRコードを印刷してください。 ",
    ...
    /* Send Transaction */
    TRANS_desc:
        "トークンを送出するには「トークン送出」のタブを選択してください。 ",
    TRANS_warning:
        "コントラクト上で、「ETHのみ」あるいは「ETCのみ」の送出を行う場合、受け入れサービスによって、これらのトランザクションに問題を生ずる場合があります。以下参照。 ",
    TRANS_advanced: "+Advanced: ガスあるいはデータを追加してください ",
    TRANS_data: "データ： ",
    TRANS_gas: "ガスリミット： ",
    TRANS_sendInfo:
        "21000ガスを使用する標準トランザクションは、0.000441 ETHを消費します。迅速な処理を行うために、若干最小量よりも多めの0.000000021 ETHのガスを使用します。当サービスでは、トランザクション料金は徴収いたしません。 ",

    /* Send Transaction Modals */
    TRANSModal_Title: "「ETHのみ」と「ETCのみ」トランザクション ",
    TRANSModal_Content_0: "異なるトランザクションと異なるサービスの注釈： ",
    TRANSModal_Content_1:
        "**ETH(標準トランザクション): ** これは、アドレス間移動のデファルトのトランザクションを生成します。デフォルトガス値は21000です。このメソッドで送出されたETHは、高い可能性でETCチェーンでリプレイされます。 ",
    TRANSModal_Content_2:
        "**ETHのみ: ** [Timon Rappのリプレイコントラクト(VB推奨)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) を使用して、**ETH**チェーンのみに送出します。 ",
    TRANSModal_Content_3:
        "**ETCのみ: ** [Timon Rappのリプレイコントラクト(VB推奨)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) を使用して、**ETC**チェーンのみに送出します。 ",
    ...
    TRANSModal_Content_5:
        "**Kraken & Poloniex:** 問題は確認されていません。どれでもお使いください。 ",
    ...
    OFFLINE_Desc:
        "オフライントランザクションの作成は、3ステップで行う事ができます。ステップ１と３はオンラインのコンピューター上で行い、ステップ２は、オフライン、あるいは物理的にネットワークと切断されたコンピューターを用います。これにより、秘密鍵が、インターネットに接続したデバイスと接触する事を避ける事ができます。 ",
    OFFLLINE_Step1_Title: "ステップ1: 情報生成 (オンラインコンピューター) ",
    OFFLINE_Step1_Button: "情報生成 ",
    OFFLINE_Step1_Label_1: "送出元アドレス： ",
    OFFLINE_Step1_Label_2:
        "ノート：これは、送出元アドレスであって、送出先アドレスではありません。操作元アカウントからは「Nonce」が生成されます。切断されたコンピューターを使用する場合に、このアドレスはコールドストレージのアカウントのものになります。 ",
    ...
    OFFLINE_Step2_Label_3b:
        "これは、ステップ１でオンラインコンピューターに表示されたものです。 ",
    OFFLINE_Step2_Label_4: "ガスリミット ",
    OFFLINE_Step2_Label_4b:
        "デフォルトガスリミット値は21000です。契約や付加データーを送出する場合には、これらの値は　異なるものにする必要があります。使用されなかったガスは全て返却されます。 ",
    OFFLINE_Step2_Label_5: "Nonce ",
    OFFLINE_Step2_Label_5b:
        "これらは、ステップ１でオンラインコンピューターに表示されたものです。 ",
    OFFLINE_Step2_Label_6: "データ ",
    OFFLINE_Step2_Label_6b:
        "これは、任意の付加データです。契約に対してトランザクションを送出する際などでよく使われます。 ",
    OFFLINE_Step2_Label_7: "秘密鍵/JSONの入力/選択 ",
    OFFLINE_Step3_Title:
        "ステップ３: トランザクションの送出/公開(オンラインコンピューター) ",
    OFFLINE_Step3_Label_1:
        "ステップ２で署名されたトランザクションをここにペーストして「トランザクションの送出」ボタンをクリックする。 ",
    ...
    MYWAL_Content_2:
        "**秘密鍵と鍵保存ファイル及びパスワード**が保管されているか確認してください。 ",
    MYWAL_Content_3:
        "MyEtherWallet CXでこのお財布を使用するためには、秘密鍵あるいはJSONとパスワードを手動で追加する必要があります。 ",

    /* Node Switcher */
    NODE_Title: "カスタムノードをセットアップ",
    NODE_Subtitle: "ローカルノードに接続するには...",
    NODE_Warning:
        "MyEtherWallet.com 経由で接続するためには、HTTPSノードが必要です。[MyEtherWalletをレポジトリからダウンロードして、手元で走らせ、](https://github.com/kvhnuke/etherwallet/releases/latest)いずれかのノードに接続することもできます。 あるいは、無料のSSL証明書を[LetsEncrypt](https://letsencrypt.org/)から入手してください",
    NODE_Name: "ノード名",
    NODE_Port: "ノードポート",
    ...
    SWAP_unlock:
        "このページから直接ETHあるいはトークンを送出するためには、お財布を解錠してください。",
    ...
    MSG_verify: "メッセージを確認 ",
    MSG_info1:
        "この署名が別の日付で再度使われないようにするために、現時点の日付を入れてください。 ",
    MSG_info2:
        "他人に使われないようにするため、あなたのニックネームとそれが使われるところを入れてください。 ",
    MSG_info3:
        "異なった目的で使用されないようにするために、利用目的を入れてください。 ",
    ...
    VIEWWALLET_Subtitle_Short:
        "異なったバージョンの秘密鍵をダウンロードしたり、お財布紙情報を再印刷することができます。 ",
    ...
    ERROR_1:
        "パスワードは少なくとも９文字が必要です。強固なパスワードであることをお確かめください。 ",
    ERROR_2:
        "申し訳ございませんが、このタイプのお財布ファイルは認識できません。 ",
    ...
    ERROR_23:
        "正しいURLを入力してください。 HTTPS接続の場合には、ノードはHTPPSで接続しなければなりません。 ",
    ERROR_24: "正しいポートを入力してください ",
    ERROR_25: "正しい chain ID を入力してください ",
    ERROR_26: "正しい ABI を入力してください ",
    ERROR_27: "最小値: 0.01. 最大値: ",
    ERROR_28:
        "お財布を操作するためには**Keystore/JSONとパスワードか秘密鍵が必要** 保存してから、外部バックアップしてください！ここで保存しないとお財布が使用できなくなります。詳細はヘルプページを参照してください。(https://www.myetherwallet.com/#help) ",
    ERROR_29: "正しいユーザーとパスワードを入力してください ",
    ERROR_30: "正しい ENS名を入力してください ",
    ERROR_31: "無効な秘密フレーズです ",
    ERROR_32:
        "ノードに接続できませんでした。Refresh your page, try a different node (upper right corner), check your firewall settings. If custom node, check your configs.", // 32
    ERROR_33:
    ...
    WARN_Send_Link:
        "自分のアドレス、リンク、ガス、データ、あるいはトランザクションタイプ（送出モード）が指定されたリンクでここに表示されています。 送出前に修正可能です。もう一度行うために、お財布を解錠してください。 ",

    /* Parity Error Messages */
    PARITY_AlreadyImported:
        "同じハッシュのトランザクションがすでにインポートされています。",
    PARITY_Old: "トランザクション nonceが小さすぎます。増やしてみてください。",
    PARITY_TooCheapToReplace:
        "トランザクションフィー不足です。同じ nonce のトランザクションが別のキューにあります。fee または nonce を増やしてみてください。",
    PARITY_LimitReached:
        "キューにあるトランザクションの数が多すぎます。上限を超えたため、対象のトランザクションは除外されています。その fee を増やしてみてください。",
    PARITY_InsufficientGasPrice:
        "トランザクションフィー不足です。 ノードの最小 fee を満たしていません。 (minimal: {}, got: {}). fee を増やしてください。",
    PARITY_InsufficientBalance:
        "ファンドが足りません。 トランザクション送出元のファンドが不足しています。 必要量 {} で 現在： {}　　です。",
    PARITY_GasLimitExceeded:
        "トランザクションコストがガスリミットを超過しました。 リミット： {}, 現在: {}. ガス供給量を減らして見てください。" /* increasing gas limit??? */,
    ...
    HELP_4CX_Desc_1:
        'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Ether送出 トークン送出" page. ',
