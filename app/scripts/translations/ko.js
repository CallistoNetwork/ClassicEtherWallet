...
ERROR_17                    : '자금이 부족합니다. 트랜잭션을 전송하려는 계좌에 충분한 자금이 없습니다. 가스 비용을 지불하기 위해서는 적어도 0.01 {}가 필요합니다. ',
...
ERROR_28                    : '지갑에 액세스하기 위해서는 **키스토어 파일과 비밀번호** (또는 개인키)가 필요합니다. 별도로 저장하여 백업해주세요. 만약 그것을 저장하지 않으면 지갑을 복원할 방법이 없습니다. 자세한 내용은 [도움말 페이지](https://www.myetherwallet.com/#help)를 참고해주세요. ',
...
ERROR_35                    : '입력된 주소가 체크섬되어있지 않습니다. <a href="https://myetherwallet.github.io/knowledge-base/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener noreferrer"> 더 보기</a>',
...
SUCCESS_3                   : 'TX가 네트워크로 브로드캐스트 되었습니다. 이는 채굴과 전송이 되었다는 것을 뜻하지 않습니다. ICO기간중에 +3시간 이상 걸릴 수 있습니다. TX해시를 보려면 하단의 확인 및 검증 버튼을 사용하세요. TX 해시:  ',
...
HELP_7_Title                : '7) 토큰 전송하기 및 사용자 정의 토큰을 어떻게 추가할 수 있나요? ',
...
HELP_21_Desc_4              : '만약 누군가가 당신의 개인 키를 소지하고 있다면 당신의 계정에서 이더리움을 보낼 수 있게 됩니다. 이 얘기는 누군가가 당신의 이메일의 비밀번호를 알고 있다면 당신의 이메일을 읽을 수 있으며, 이메일이나 누군가가 출금할 수 있도록 당신의 은행 계정 비밀번호를 전송할 수 있다는 것과 마찬가지입니다. 당신은 비밀번호로 암호화된 개인 키인 ‘개인 키의 키스토어 버전’을 다운로드 할 수 있습니다. 이것은 다른 암호로 보호되는 비밀번호를 갖게 되는 것입니다. ',
...
HELP_SecCX_Desc_6           : '별명과 지갑 주소를 암호화하면 계정 잔액과 별명들을 확인할 때마다 비밀번호를 입력해야 합니다. 보안이 걱정된다면 Chrome 확장 프로그램 대신 MyEtherWallet.com 을 사용해주세요. ',
