...
no.data = {
    ...
    x_JsonDesc:
        "Dette er det ukrypterte JSON-formatet av din private nøkkel. Dette betyr at du ikke trenger noe passord, men også at den som finner din JSON kan få tilgang til lommeboken din og etherne dine uten passord. ",
    ...
    x_PrintDesc:
        'Profftips: Klikk "skriv ut" og lagre som PDF, selv om du ikke har noen skriver! ',
    x_PrintShort: "Skriv ut ",
    x_PrivKey: "Privat nøkkel (ukryptert) ",
    x_PrivKey2: "Privat nøkkel ",
    x_PrivKeyDesc:
        "Dette er den ukrypterte tekstversjonen av den private nøkkelen din, noe som betyr at det ikke er nødvendig med noe passord. Hvis noen skulle få tak i den ukrypterte private nøkkelen din, ville de få tilgang til lommeboken din uten å bruke passord. Derfor er krypterte nøkler vanligvis å anbefale. ",
    x_Save: "x_Lagre ",
    ...
    /* Header */
    MEW_Warning_1:
        'Sjekk alltid nettsideadressen før du bruker eller oppretter en lommebok. Pass opp for "phishing"-nettsider! ',
    CX_Warning_1:
        "Sørg for at du har **eksterne sikkerhetskopier** av alle lommebøker som du lagrer her. Mye kan hende som vil kunne medføre at du mister informasjonen i denne Chrome-utvidelsen, inkludert avinstallasjon og reinstallasjon av utvidelsen. Denne utvidelsen gir deg enkel tilgang til lommebøkene dine, men er **ikke** en måte å sikkerhetskopiere dem på. ",
    MEW_Tagline:
        "Open Source JavaScript Client-Side Ether Wallet " /* Intentionally not translated */,
    CX_Tagline:
        "Open Source JavaScript Client-Side Ether Wallet Chrome Extension " /* Intentionally not translated */,

    /* Footer */
    FOOTER_1:
        "Et åpen-kildekode-, javascript-, klient-side-verktøy for å opprette Ethereum-lommebøker & sende transaksjoner. ",
    FOOTER_1b: "Skapt av ",
    ...
    ADD_Warning_1:
        "Du kan legge til hvilken som helst konto som du vil overvåke på lommebok-siden uten å laste opp en privat nøkkel. Dette betyr ** ikke ** at du har tilgang til denne lommeboken, eller at du kan overføre ether fra den. ",
    ...
    ADD_Ledger_4:
        "Hvis du ikke finner noen nettleserstøtte i innstillingene, sjekk at du har [Firmware >1.2](https://www.ledgerwallet.com/apps/manager) ",
    ADD_Ledger_0a:
    ...
    GEN_Label_2:
        "Lagre din Keystore-fil og/eller private nøkkel. Ikke glem passordet ditt ovenfor. ",
    ...
    SENDModal_Content_4:
        'NB: Hvis det oppstår en feil, må du sannsynligvis legge til ether til kontoen din for å dekke "gas"-kostnaden for å sende ether/token. "Gas" betales i ether. ',
    ...
    /* Send Transaction */
    TRANS_desc:
        'Hvis du ønsker å sende token, vennligst bruk "Send Token"-siden i stedet. ',
    TRANS_warning:
        'Hvis du bruker "Kun ETH"- eller "Kun ETC"-funksjonene, sender du via en kontrakt. Noen tjenester har problemer med å akseptere disse transaksjonene. Les mer. ',
    TRANS_advanced: "+Avansert: Legg til data ",
    TRANS_data: "Data ",
    TRANS_gas: "Gas Limit ",
    TRANS_sendInfo:
        "En standard transaksjon som bruker 21000 gas vil koste 0,000441 ETH. Vi bruker en litt-over-minimum gas-pris på 0,000000021 ETH for å sikre at transaksjonen blir raskt behandlet. Vi tar ikke noe transaksjonsgebyr. ",

    /* Send Transaction Modals */
    TRANSModal_Title: '"Kun ETH"- og "Kun ETC"-transaksjoner ',
    TRANSModal_Content_0:
        "En notis om forskjellige transaksjoner og tjenester: ",
    ...
    TRANSModal_Content_2:
        "**Kun ETH: ** Dette sender via [Timon Rapp's replay-beskyttelseskontrakt (som anbefalt av VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) slik at du kun sender på **ETH**-kjeden. ",
    TRANSModal_Content_3:
        "**Kun ETC: ** Dette sender via [Timon Rapp's replay-beskyttelseskontrakt (som anbefalt av VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) slik at du kun sender på **ETC**-kjeden. ",
    TRANSModal_Content_4:
        '**Coinbase & ShapeShift: ** Send kun via Standard transaksjon. Hvis du sender via "Kun"-kontraktene, vil du måtte ta kontakt med deres kundestøttepersonell for å manuelt legge til saldoen din eller få en tilbakebetaling. [Du kan også prøve Shapeshift sitt "splitte"-verktøy.](https://split.shapeshift.io/) ',
    TRANSModal_Content_5:
        "**Kraken & Poloniex:** Ingen kjente problemer. Bruk det som passer. ",
    TRANSModal_Yes: "Flott, jeg skjønner det nå. ",
    TRANSModal_No:
        "Trøste og bære, nå er jeg bare enda mer forvirret. Hjelp meg. ",

    /* Offline Transaction */
    OFFLINE_Title: "Generer & send offline transaksjon ",
    OFFLINE_Desc:
        "Generering av offline-transaksjoner kan utføres i tre steg. Du utfører steg 1 og 3 på en internettilknyttet datamaskin, og steg 2 på en offline/frakoblet datamaskon. Dette sikrer at dine private nøkler ikke kommer i kontakt med en internettilknyttet enhet. ",
    OFFLLINE_Step1_Title:
        "Steg 1: Generer informasjon (internettilknyttet datamaskin) ",
    OFFLINE_Step1_Button: "Generer informasjon ",
    OFFLINE_Step1_Label_1: "Fra-adresse ",
    OFFLINE_Step1_Label_2:
        'NB: Dette er FRA-adressen, ikke TIL-adressen. "Nonce" genereres fra den opprinnelige kontoen. Hvis du bruker en frakoblet datamaskin, vil dette være adressen til "kald-lager"-kontoen (dvs. kontoen som lagres frakoblet internett). ',
    ...
    OFFLINE_Step2_Label_3b:
        "Dette kom fram i steg 1 på den internettilknyttede maskinen. ",
    OFFLINE_Step2_Label_4: "Gas-grense ",
    OFFLINE_Step2_Label_4b:
        "21000 er standard gas-grense. Når du sender kontrakter eller ekstra data, kan det hende at grensen må settes høyere. Eventuelt ubrukt gas blir returnert til deg. ",
    OFFLINE_Step2_Label_5: "Nonce ",
    OFFLINE_Step2_Label_5b:
        "Dette kom fram i steg 1 på den internettilknyttede maskinen. ",
    OFFLINE_Step2_Label_6: "Data ",
    OFFLINE_Step2_Label_6b:
        "Dette er valgfritt. Data brukes ofte når du sender transaksjoner til kontrakter. ",
    OFFLINE_Step2_Label_7: "Skriv inn / Velg din private nøkkel / JSON. ",
    OFFLINE_Step3_Title:
        "Steg 3: Send / Publiser transaksjon (internettilknyttet datamaskin) ",
    OFFLINE_Step3_Label_1:
        'Overfør (f.eks. via USB-minnepinne) den signerte transaksjonen fra steg 2 og lim den inn her. Trykk så "SEND TRANSAKSJON"-knappen. ',
    ...
    MSG_info1:
        "Inkluder dagens dato slik at signaturen ikke kan brukes på nytt på en annen dato. ",
    MSG_info2:
        "Inkluder brukernavnet ditt og hvor du benytter dette navnet slik at ingen andre kan benytte det. ",
    MSG_info3:
        "Inkluder en spesifikk grunn for meldingen så den ikke kan brukes på nytt for et annet formål. ",

    /* Mnemonic */
    MNEM_1: "Vennligst velg adressen du vil jobbe med. ",
    MNEM_2:
        'Din "HD-mnemoniske frase" kan gi deg tilgang til flere lommebøker / adresser. Vennligst velg den adressen du vil jobbe med denne gangen. ',
    ...
    SWAP_unlock:
        "Lås opp din lommebok for å sende ETH eller Tokens direkte fra denne siden. ",
    ...
    MYWAL_Content_2:
        "Vær sikker på at du har **lagret den private nøkkelen/JSON-filen og passordet** tilknyttet denne lommeboken før du fjerner den. ",
    MYWAL_Content_3:
        "Hvis du ønsker å bruke denne lommeboken med din MyEtherWallet Chrome-utvidelse i fremtiden, må du manuelt legge den til igjen ved å bruke den private nøkkelen/JSON og passord. ",

    /* View Wallet Details */
    VIEWWALLET_Subtitle:
        'Dette gir deg muligheten til å laste ned ulike versjoner av private nøkler og skrive ut papirlommeboken din på nytt. Du vil kanskje gjøre dette for å [importere kontoen din til Geth/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Hvis du bare ønsker å sjekke saldoen din, anbefaler vi at du bruker en "blockchain explorer" som f.eks. [gastracker.io](https://gastracker.io/) (ETC) / [etherscan.io](https://etherscan.io/) (ETH). ',
    ...
    /* Chrome Extension */
    CX_error_1:
        'Du har ennå ikke lagret noen lommebok. Klikk ["Legg til lommebok"](/cx-wallet.html#add-wallet) for å legge til en! ',
    CX_quicksend: "Send ", // if no appropriate translation, just use "Send"

    /* Error Messages */
    ERROR_0: "Vennligst oppgi et gyldig beløp. ",
    ERROR_1:
        "Passordet ditt må inneholde minst 9 tegn. Vennligst sørg for at det er et sterkt passord. ",
    ...
    ERROR_15:
        "Det ser ikke ut til at et forslag med denne ID-en eksisterer ennå, eller det er en feil ved innlesning av dette forslaget. ",
    ERROR_16:
    ...
    ERROR_20:
        "er ikke en gyldig ERC-20-token. Hvis andre tokens holder på å lastes, vennligst fjern denne token og prøv igjen. ",
    ERROR_21:
        "Kunne ikke estimere gas. Det er enten ikke nok midler på kontoen, eller så gir den mottakende kontraktadressen en feilmelding. Prøv å justere gas-mengden manuelt, og fortsett. Feilmeldingen du får når du sender kan være mer informativ. ",
    ERROR_22: "Vennligst oppgi gyldig nodenavn ",
    ERROR_23:
        "Oppgi gyldig URL (internett-adresse), hvis du er på https må URL-en starte med https ",
    ...
    GETH_NonExistentAccount:
        "Kontoen eksisterer ikke eller saldoen er for lav ",
    ...
    PARITY_Old:
        "Transaksjonens nonce er for lav. Prøv å øke nonce gradvis (+1).",
    PARITY_TooCheapToReplace:
        "Transaksjonsavgiften er for lav. Det er en annen transaksjon med samme nonce i køen. Prøv å øke avgiften eller øke nonce (+1).",
    PARITY_LimitReached:
        "Det er for mange transaksjoner i køen. Transaksjonen din ble derfor droppet. Prøv å øke avgiften.",
    PARITY_InsufficientGasPrice:
        "Transaksjonsavgiften er for lav. Den tilfredsstiller ikke minimumsavgiften til noden din. (minimum: {}, fått: {}). Prøv å øke avgiften.",
    PARITY_InsufficientBalance:
        "Utilstrekkelige midler. Kontoen du prøver å sende transaksjon fra har ikke nok midler. Påkrevd {} og fått: {}.",
    PARITY_GasLimitExceeded:
        "Transaksjonskostnaden overskrider nåværende gas-grense. Grense: {}, fått: {}. Prøv å redusere tilført gas.",
    ...
    HELP_Warning:
        "Hvis du opprettet en lommebok -eller- lastet ned repoet før **31. desember 2015**, vennligst sjekk lommebøkene dine &amp; last ned en ny versjon av repoet. Klikk for detaljer. ",
    HELP_Desc:
        "Ser du noe som mangler? Har du flere spørsmål? [Ta kontakt med oss](mailto:support@myetherwallet.com), så vil vi ikke bare besvare spørsmålet ditt, men vi vil også oppdatere denne siden så den blir mer nyttig i framtiden! ",
    ...
    HELP_Remind_Desc_3:
        "Hvis du ikke lagrer din private nøkkel & passord, finnes det ingen måte å gjenopprette din lommebok på, eller midlene den inneholder. Sikkerhetskopier dem på flere fysiske lokasjoner &ndash; ikke bare på datamaskinen din! ",
    ...
    HELP_0_Desc_4:
        "Verifiser at du har tilgang til denne nye lommeboken (f.eks. ved å overføre et ørlite beløp til og fra den nye lommeboken), og at all nødvendig informasjon er lagret og korrekt. ",
    ...
    HELP_1_Desc_2:
        'Gå til "Legg til lommebok"-siden & velg "Opprett ny lommebok" ',
    HELP_1_Desc_3:
        "Oppgi et sterkt passord. Hvis du ikke tror du klarer å huske det, skriv det opp på et sikkert sted. Du kommer til å trenge dette passordet for å sende transaksjoner. ",
    ...
    HELP_2a_Desc_2:
        "Lagre adressen. Du kan holde den for deg selv eller dele den med andre. På den måten kan andre overføre ether til deg. ",
    HELP_2a_Desc_3:
        "Lagre versjoner av den private nøkkelen. Ikke del den med noen andre. Din private nøkkel er nødvendig hvis du vil ha tilgang til (og sende) etheren din! Det er 3 typer private nøkler: ",
    HELP_2a_Desc_4:
        "Plasser adressen din, versjoner av den private nøkkelen, og PDF-versjonen av papirlommeboken i en folder. Lagre denne på datamaskinen din og en USB-disk. ",
    HELP_2a_Desc_5:
        "Skriv ut lommeboken hvis du har en skriver. Hvis ikke, skriv ned adressen og den private nøkkelen din på et papirark. Lagre dette på et sikkert sted, separat fra datamaskinen og USB-disken. ",
    HELP_2a_Desc_6:
    ...
    HELP_2b_Desc_6:
        "Lagre adressen. Lagre versjoner av den private nøkkelen. Lagre passordet hvis du ikke tror du klarer å huske det for alltid. ",
    HELP_2b_Desc_7:
        "Lagre disse papirene / USB-ene på flere fysisk separate steder. ",
    HELP_2b_Desc_8:
        'Gå til "Vis lommebok-info"-siden og oppgi (lim inn) din private nøkkel / passord for å sikre at de er korrekte og gir deg tilgang til lommeboken din. Sjekk at adressen du skrev ned er den samme. ',

    HELP_3_Title:
        "3) Hvordan verifiserer jeg at jeg har tilgang til den nye lommeboken min? ",
    HELP_3_Desc_1:
    ...
    HELP_3_Desc_3:
        'Naviger til MyEtherWallet.com sin "Vis lommebok-info"-side. ',
    HELP_3_Desc_4:
        "Velg lommebok-filen din, eller din private nøkkel, og lås opp lommeboken din. ",
    HELP_3_Desc_5:
        "Hvis lommeboken er kryptert, vil det automatisk dukke opp en tekstboks. Oppgi passordet. ",
    HELP_3_Desc_6: 'Klikk "Lås opp lommebok"-knappen. ',
    HELP_3_Desc_7:
        "Informasjon om lommeboken din skal nå dukke opp. Finn konto-adressen din ved siden av et fargerikt, sirkulært ikon. Dette ikonet er en unik, visuell representasjon av din adresse. Vær sikker på at adressen er den samme adressen som du har lagret i tekstdokumentet og papirlommeboken. ",
    HELP_3_Desc_8:
        "Hvis du planlegger å lagre et stort ether-beløp, anbefaler vi at du sender et lite beløp til- og fra den nye lommeboken før du deponerer et stort beløp. Send 0,001 ether til din nye lommebok, åpne lommeboken, send de 0,001 eterne (-minus gas-kostnad) til en annen adresse, og forikre deg om at alt fungerer som det skal. ",
    ...
    HELP_4_Desc_3:
        "Velg lommebok-filen din, eller din private nøkkel, og lås opp lommeboken din. ",
    HELP_4_Desc_4:
        "Hvis lommeboken er kryptert, vil det automatisk dukke opp en tekstboks hvor du må oppgi passordet ditt. ",
    HELP_4_Desc_5: 'Klikk på "Lås opp lommebok"-knappen. ',
    HELP_4_Desc_6:
        'Oppgi adressen som du ønsker å sende til i "Til adresse:"-feltet. ',
    HELP_4_Desc_7:
        'Oppgi beløpet som du ønsker å sende. Du kan også klikke på "Send hele saldoen"-lenken hvis du ønsker å overføre hele saldoen. ',
    HELP_4_Desc_9: 'Klikk "Generer transaksjon". ',
    HELP_4_Desc_10:
        "En del felter vil dukke opp. Dette er nettleseren din som genererer transaksjonen. ",
    ...
    HELP_4CX_Desc_1:
        'Først må du legge til en lommebok. Når du har gjort det, har du 2 muligheter: den kjappe "Send"-funksjonaliteten fra Chrome-utvidelsesikonet eller "Send Ether & Tokens"-siden. ',
    ...
    HELP_4CX_Desc_6:
        'Oppgi adressen du ønsker å sende til i "Til adresse:"-feltet. ',
    HELP_4CX_Desc_7:
        'Oppgi beløpet du vil sende. Du kan også klikke på "Send hele saldoen"-lenken hvis du vil overføre hele saldoen. ',
    ...
    HELP_5_Desc_7:
        "MyEtherWallet.com kjører nå utelukkende på din datamaskin. ",
    HELP_5_Desc_8:
    ...
    HELP_5CX_Title:
        "5) Hvordan kan jeg installere denne utvidelsen fra repoet i stedet for fra Chrome-butikken? ",
    HELP_5CX_Desc_2: "Klikk `chrome-extension-vX.X.X.X.zip`. ",
    HELP_5CX_Desc_3:
        'Gå til Google Chrome og finn innstillingene i menyen øverst til høyre under "Flere verktøy". ',
    ...
    HELP_5CX_Desc_7:
        'Naviger til den nå utpakkede mappen som du lastet ned tidligere. Clikk "OK". ',
    HELP_5CX_Desc_8:
        "Utvidelsen skal nå dukke opp blant utvidelsene dine og i utvidelses-knappelinjen øverst til høyre i nettleseren. ",

    HELP_7_Title:
        "7) Hvordan sender jeg token & legger til flere typer token? ",
    HELP_7_Desc_0:
    ...
    HELP_7_Desc_3:
        'Oppgi adressen som du vil sende til i "Til adresse:"-feltet. ',
    ...
    HELP_7_Desc_8:
        'Oppgi adressen, navnet, og antall desimaler for token-et. Disse er oppgitt fra utviklerne av token-et og er også nødvendige når du skal "Add a Watch Token" i Mist. ', //Mist not translated to Norw yet :-)//
    HELP_7_Desc_9: 'Klikk "Lagre". ',
    HELP_7_Desc_10:
        "Du kan nå sende denne typen token, samt se saldoen for aktuell token i sidefeltet. ",
    HELP_7_Desc_11: 'Klikk "Generer transaksjon". ',
    HELP_7_Desc_12:
        "Noen flere felter vil dukke opp. Dette er nettleseren din som genererer transaksjonen. ",
    ...
    HELP_8CX_Title:
        "8) Hva skjer hvis MyEtherWallet CX (Chrome-utvidelsen) forsvinner? ",
    HELP_8CX_Desc_1:
        "For det første er alle data lagret på din datamaskin, ikke på våre servere. Jeg vet det kan være forvirrende, men når du ser på Chrome-utvidelsen, så ser du IKKE på ting som er lagret på våre servere et eller annet sted - det er alt sammen lagret på din egen datamaskin. ",
    HELP_8CX_Desc_2:
        "Når det er sagt, så er det **svært viktig** at du sikkerhetskopierer all din informasjon for alle lommebøkene som du har opprettet med MyEtherWallet CX. På den måten vil du fortsatt ha all nødvendig informasjon for å få tilgang til eteren din selv om noe skulle hende med MyEtherWallet CX eller datamaskinen din. Se spørsmål #2a ang. hvordan du sikkerhetskopierer lommebøkene dine. ",
    HELP_8CX_Desc_3:
        "Hvis MyEtherWallet CX av en eller annen grunn skulle forsvinne fra Chrome Store, så kan du finne kildekoden på Github og laste den inn manuelt. Se #5 ovenfor. ",
    ...
    HELP_10_Desc_1:
        'Naviger til "Send Offline"-siden via din internettilknyttede datamaskin. ',
    HELP_10_Desc_2:
        'Oppgi "Fra-adressen". Vennligst merk at dette er adressen du sender FRA, ikke TIL. Dette genererer "nonce" og "gas-pris". ',
    HELP_10_Desc_3:
        'Gå til den internettfrakoblede datamaskinen. Oppgi "TIL-ADRESSEN" og "BELØPET" du vil sende. ',
    HELP_10_Desc_4:
        'Oppgi "GAS-PRISEN" slik den ble vist deg på den tilkoblede datamaskinen i steg #1. ',
    HELP_10_Desc_5:
        'Oppgi "NONCE" slik den ble vist deg på den tilkoblede datamaskinen i steg #1. ',
    HELP_10_Desc_6:
        '"GAS-GRENSE" har en standardverdi på 21000. Dette vil dekke en standardtransaksjon. Hvis du sender til en kontrakt eller inkluderer ekstra data i transaksjonen din, må du øke gas-grensen. Eventuelt overskytende gas blir returnert til deg (fra-kontoen). ',
    HELP_10_Desc_7:
        "Oppgi noe data hvis du vil. Hvis du oppgir data, må du inkludere mer enn det som er standard gas-grense (21000). Alle data er i HEX-format. ",
    HELP_10_Desc_8:
        "Velg lommebokfilen din, eller din private nøkkel, og lås opp lommeboken din. ",
    HELP_10_Desc_9: 'Trykk på "GENERER SIGNERT TRANSAKSJON"-knappen. ',
    HELP_10_Desc_10:
        "Datafeltet under denne knappen vil fylles med din signerte transaksjon. Kopier denne og flytt den tilbake til din tilkoblede datamaskin. ",
    HELP_10_Desc_11:
        'Lim inn den signerte transaksjonen i tekstfeltet i steg #3 på den tilkoblede maskinen og klikk "Send Ether & Tokens". Dette vil kringkaste transaksjonen din. ',

    HELP_12_Title:
        "12) Hvordan kan jeg importere en lommebok opprettet med MyEtherWallet til geth / Ethereum Wallet / Mist? ",
    HELP_12_Desc_1:
        "Ved å bruke en Geth/Mist JSON-fil fra MyEtherWallet v2+.... ",
    HELP_12_Desc_2: 'Gå til "Vis lommebok-info"-siden. ',
    HELP_12_Desc_3:
        "Lås opp lommeboken din ved hjelp av din **krypterte** private nøkkel eller JSON-fil. ",
    HELP_12_Desc_4: 'Gå til "Mine lommebøker"-siden. ',
    HELP_12_Desc_5:
        'Velg lommeboken som du ønsker å importere til Mist, klikk "Vis"-ikonet, oppgi passordet, og få tilgang til lommeboken. ',
    HELP_12_Desc_6:
        'Finn "Last ned JSON-fil - Geth/Mist-format (kryptert)"-seksjonen. Trykk "Last ned"-knappen nedenfor. Du har nå fått keystore-filen til lommeboken din. ',
    HELP_12_Desc_7: 'Åpne "Ethereum Wallet"-programmet. ',
    HELP_12_Desc_8:
        'I menyfeltet, gå til "Accounts" -> "Backup" -> "Accounts" ',
    HELP_12_Desc_9:
        "Dette vil åpne keystore-mappen på harddisken din. Kopier filen du nettopp lastet ned (`UTC--2016-04-14......../`) inn i denne keystore-mappen. ",
    HELP_12_Desc_10:
        'Kontoen din skal nå umiddelbart dukke opp under "Accounts." ',
    HELP_12_Desc_11: "Ved å bruke din ukrypterte private nøkkel... ",
    HELP_12_Desc_12:
        'Hvis du ikke allerede har den ukrypterte private nøkkelen din, naviger til "Vis lommebok-info"-siden. ',
    HELP_12_Desc_13:
        "Velg lommebok-filen din, eller oppgi/lim inn din private nøkkel, for å låse opp lommeboken. ",
    ...
    HELP_13_Title:
        '13) Hva betyr "Utilstrekkelige midler. Kontoen du prøver å sende transaksjon fra har ikke nok midler. Påkrevd XXXXXXXXXXXXXXXXXXX og fått: XXXXXXXXXXXXXXXX." ? ',
    HELP_13_Desc_1:
    ...
    HELP_14_Title:
        "14) Noen nettsider randomiserer genereringen av den private nøkkelen via musebevegelser. MyEtherWallet.com gjør ikke dette. Er metoden som MyEtherWallet bruker til å generere tilfeldige tall sikker? ",
    HELP_14_Desc_1:
    ...
    HELP_15_Title:
        "15) Hvorfor har ikke kontoen jeg nettopp opprettet dukket opp i blokkjede-utforskeren? (ie: etherchain, etherscan) ",
    HELP_15_Desc_1:
        "Kontoer vil kun dukke opp i en blokkjede-utforsker når kontoen har hatt aktivitet&mdash;for eksempel, når du har overført Ether til den. ",

    HELP_16_Title: "16) Hvordan kan jeg sjekke saldoen på kontoen min? ",
    HELP_16_Desc_1:
        "Du kan bruke en blokkjede-utforsker som [gastracker.io](https://gastracker.io/) (ETC) / [etherscan.io](https://etherscan.io/) (ETH). Lim inn adressen i søkefeltet og den vil finne fram adressen og transaksjonshistorikken. For eksempel, her ser du hvordan vår [donasjonskonto](http://etherscan.io/address/0x7cb57b5a97eabe94205c07890be4c1ad31e486a8) ser ut på etherscan.io ",

    HELP_17_Title:
        "17) Hvorfor vises ikke saldoen min når jeg låser opp lommeboken min? ",
    HELP_17_Desc_1:
    ...
    HELP_21_Title:
        "21) Kan ikke hvem som helst legge inn tilfeldige private nøkler, sjekke saldoen, og sende Ether til sin egen adresse? ",
    HELP_21_Desc_1:
    ...
    HELP_SecCX_Desc_2:
        "Informasjonen som du lager i denne Chrome-utvidelsen lagres via [chrome.storage](http://chrome.storage/). - dette er samme sted som passordene dine lagres når du lagrer passord i Chrome. ",
    HELP_SecCX_Desc_3: "Hvilken informasjon lages? ",
    HELP_SecCX_Desc_4:
        "Adresser, kallenavn og private nøkler lagres i chrome.storage. Den private nøkkelen er kryptert ved hjelp av passordet du satte da du la til lommeboken. Kallenavn og lommebok-adresser er ikke kryptert. ",
    HELP_SecCX_Desc_5:
        "Hvorfor er ikke kallenavn og lommebok-adresser kryptert? ",
    HELP_SecCX_Desc_6:
        "Hvis vi skulle kryptere disse, måtte du ha oppgitt et passord hver gang du ønsket å se saldo for kontoene dine eller vise kallenavnene. Hvis dette bekymrer deg, anbefaler vi deg å bruke MyEtherWallet.com i stedet for denne Chrome-utvidelsen. ",
