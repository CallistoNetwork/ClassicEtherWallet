...
vi.data = {
    ...
    x_Print: "Tạo Ví Giấy ",
    x_PrintDesc:
        'Mẹo: kích chuột trái vào nút "In Ví" sau đó chọn "Save this as a PDF" đễ lưu nó thành định dạng PDF trên máy tính của bạn nếu bạn không sở hữu máy in cá nhân! ',
    x_PrintShort: "In Ví ",
    x_PrivKey: "Private Key (Không mã hoá) ",
    x_PrivKey2: "Private Key ",
    x_PrivKeyDesc:
        "Đây là một đoạn dữ liệu có định dạng bằng văn bản không bị mã hoá và nó chính là private key của bạn. Nếu người nào sở hữu Private Key của bạn thì họ có thể truy cập vào ví của bạn mà không cần đến mật khẩu. Vì vậy, Chúng tôi khuyên bạn nên dùng phiên bản có định dạng đã được mã hoá. ",
    x_Save: "Lưu ",
    ...
    /* Header */
    MEW_Warning_1:
        "Chú Ý! kiễm tra cẩn thận URL trước khi bạn muốn đăng nhập vào ví hoặc tạo một ví mới. Cảnh giác cao đối với những trang web lừa đảo! ",
    CX_Warning_1:
        "Hãy chắc chắn rằng bạn đã thực hiện việc sao lưu dữ liệu cho những ví bạn đang sử dụng tại đây. Nhiều khả năng có thể xảy ra sẽ dẩn đến việc mất đi dữ liệu mà bạn lưu tại phần mở rộng của Chrome (bao gồm việc gỡ bỏ cài đặt và cài đặt lại các phần mở rộng). Phần mở rộng này là cách dễ dàng đễ truy cập vào ví của bạn, nhưng nó không phải là nơi đễ bạn sao lưu dữ liệu. ",
    ...
    ADD_Warning_1:
        "Bạn có thể thêm bất kỳ tài khoản nào bạn muốn theo dõi trên ví mà không cần đến Mật khẩu bảo mật. Việc này không có nghĩa là bạn đã truy cập vào bên trong ví. Do đó bạn sẽ không thực hiện được giao dịch tại chức năng này. ",
    ...
    /* Generate Wallets */
    GEN_desc:
        "Nếu bạn muốn tạo nhiều ví cùng một lúc, bạn có thể thực hiện tại đây ",
    GEN_Label_1:
        "Tạo mật khẩu thật mạnh nhằm bảo mật tài khoản (ít nhất 9 ký tự) ",
    ...
    SENDModal_Content_4:
        "Lưu Ý: Nếu bạn gặp lỗi, bạn cần phải thêm ether vào tài khoản của bạn để thanh toán chi phí gas của việc gửi Token. Gas được thanh toán bằng ether. ",
    ...
    /* Send Transaction */
    TRANS_desc:
        'Nếu bạn muốn gửi Token, xin vui lòng sử dụng danh mục "Gửi Token". ',
    TRANS_warning:
        'Nếu bạn sử dụng chức năng "Chỉ ETH" hoặc "Chỉ ETC" trong việc gửi đi thông qua một hợp đồng thông minh. Những dịch vụ có chức năng chấp nhận các giao dịch. Đọc Thêm. ',
    TRANS_advanced: "Nâng Cao: Thêm Dữ Liệu ",
    TRANS_data: "Dữ Liệu: ",
    TRANS_gas: "Gas Limit: ",
    TRANS_sendInfo:
        "Mỗi Giao dịch Phổ Thông sử dụng hết 21000 gas có giá tương đương 0.000441 ETH. Chúng tôi áp dụng giá Gas dành cho một giao dịch cao hơn so với mức tối thiểu là 0.000000021 ETH nhằm đảm bảo một giao dịch được diễn ra nhanh. Chúng tôi hoàn toàn không nhận được khoản tiền phát sinh nào từ phí giao dịch. ",

    /* Send Transaction Modals */
    TRANSModal_Title: 'Giao Dịch "Chỉ ETH" Và "Chỉ ETC" ',
    TRANSModal_Content_0:
        "Một số lưu ý về sự khác biệt của từng loại giao dịch và sự khác biệt của từng dịch vụ: ",
    TRANSModal_Content_1:
        "**ETH (Giao Dịch Phổ Thông): ** Phương pháp này mặc định rằng nó sẽ tạo giao dịch từ một địa chỉ gửi đến địa chỉ nhận khác và nó sẽ tiêu thụ hết 21000 gas. Theo giả thuyết thì bất kì số ETH gửi đi thông qua phương pháp này sẽ được thực hiện lại tương tự trên chuổi ETC. ",
    TRANSModal_Content_2:
        '**Chỉ ETH: ** Phương pháp này sẽ thực hiện giao dịch thông qua [Hợp đồng thông minh nhằm "tránh việc phát lại" được phát triển bởi Timon Rapp (theo lời cảnh báo của VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) vì vậy giao dịch này chỉ được thực hiện trên chuổi **ETH**. ',
    TRANSModal_Content_3:
        '**Chỉ ETC: ** Phương pháp này sẽ thực hiện giao dịch thông qua [Hợp đồng thông minh nhằm "tránh việc phát lại" được phát triển bởi Timon Rapp (theo lời cảnh báo của VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) vì vậy giao dịch này chỉ được thực hiện trên chuổi **ETC**. ',
    ...
    OFFLINE_Step1_Label_2:
        "Lưu ý: Đây phải là tài khoản gửi, không phải tài khoản đến. Nonce sẽ được tạo ra từ tài khoản có nguồn gốc. Nếu sử dụng máy tính có tình trạng airgapped, thì nó sẽ trở thành địa chỉ của tài khoản lưu trữ lạnh. ",
    ...
    OFFLINE_Step2_Label_3b:
        "Điều này đã được hiển thị ở bước 1 trên máy tính trực tuyến của bạn. ",
    OFFLINE_Step2_Label_4: "Giới hạn Gas ",
    OFFLINE_Step2_Label_4b:
        "21000 măc định sẽ là số gas giới hạn. khi bạn gửi đi một hợp đồng hoặc thêm dữ liệu, việc này sẽ cần phải làm khác đi. Lượng Gas không được sử dụng sẽ hoàn trả cho bạn. ",
    OFFLINE_Step2_Label_5: "Nonce ",
    OFFLINE_Step2_Label_5b:
        "Điều này đã được hiển thị ở bước 1 trên máy tính trực tuyến của bạn. ",
    OFFLINE_Step2_Label_6: "Dữ Liệu ",
    OFFLINE_Step2_Label_6b:
        "Đây là phần tùy chọn. Dữ liệu thường được sử dụng khi bạn gửi các giao dịch hợp đồng. ",
    OFFLINE_Step2_Label_7: "Nhập / Chọn  Private Key / JSON của bạn. ",
    OFFLINE_Step3_Title:
        "Bước 3: Gửi / Làm rõ Giao Dịch (Máy tính đang Online) ",
    OFFLINE_Step3_Label_1:
        'Dán chữ ký Giao Dịch được tạo từ Bước 2 vào đây và chọn nút "Thực hiện Giao Dịch". ',
    ...
    ADD_Ledger_3:
        "Xác nhận lại phần Hổ Trợ dành cho Trình Duyệt đã được kích hoạt trong mục Cài Đặt ",
    ADD_Ledger_4:
        "Nếu mục Hổ Trợ dành cho Trình duyệt không tìm thấy trong mục Cài Đặt, Xác nhận lại bạn đã có [Firmware >1.2](https://www.ledgerwallet.com/apps/manager) hay chưa ",
    ADD_Ledger_0a:
    ...
    MYWAL_Content_2:
        "Hãy chắc chắn bạn đã **Lưu giữ Private Key hoặc Tập Tin chứa định dạng Keystore và mật khẩu** Trước khi bạn gỡ bỏ nó. ",
    MYWAL_Content_3:
        "Nếu bạn muốn sử dụng địa chỉ Ví này với MyEtherWallet CX trong tương lai, bạn sẽ cần phải tự thêm vào lại bằng cách sử dụng tập tin Private Key / JSON và mật khẩu. ",

    /* View Wallet Details */
    VIEWWALLET_Subtitle:
        "Việc này cho phép bạn tải về các phiên bản khác nhau của Private Key và in lại ví giấy của bạn. Bạn có thể muốn làm điều này để [nhập tài khoản của bạn vào Geth/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Nếu bạn muốn kiễm tra số dư của bạn, chúng tôi khuyên bạn sử dụng một blockchain explorer như [gastracker.io](https://gastracker.io/) (ETC) / [etherscan.io](https://etherscan.io/) (ETH). ",
    ...
    MNEM_2:
        "Cụm từ dễ nhớ đó có thể truy nhập vào số địa chỉ Ví của bạn. Vui lòng chọn địa chỉ mà bạn muốn tương tác tại thời điểm này. ",
    MNEM_more: "Nhiều địa chỉ ",
    MNEM_prev: "Địa chỉ trước đó ",

    /* Chrome Extension */
    CX_error_1:
        'Bạn không có bất kỳ ví nào được lưu lại. Chọn Nút ["Thêm Ví"](/cx-wallet.html#add-wallet) để thêm ví! ',
    CX_quicksend: "Gửi Nhanh ", // if no appropriate translation, just use "Send"

    /* Error Messages */
    ERROR_0: "Vui lòng nhập số dư hợp lệ. ",
    ERROR_1:
        "Mật khẩu của bạn phải có ít nhất 9 ký tự. Hãy đảm bảo rằng nó là một mật khẩu mạnh. ",
    ERROR_2:
        "Lấy làm tiếc! Chúng tôi không nhận ra loại Định Dạng từ tập tin ví. ",
    ...
    ERROR_15:
        "Trông có vẻ như một proposal ới số ID này chưa kết thúc hoặc đang có một lỗi xảy ra để đọc được proposal này. ",
    ERROR_16:
        "Đã có một ví với địa chỉ này đang tồn tại trong mục lưu trữ. Vui lòng kiễm tra trang ví của bạn. ",
    ERROR_17:
        "Bạn cần có ít nhất **0.01 ETH** trong tài khoản để thanh toán chi phí gas. Hãy thêm một số ether và thực hiện lại. ",
    ERROR_18:
        "Toàn bộ gas sẽ được sử dụng trong giao dịch này. Việc làm này có nghĩa là bạn đã bỏ phiếu cho đề xuất này hoặc kỳ hạn của cuộc tranh luận đã kết thúc. ",
    ...
    GETH_InsufficientFunds:
        "Số dư không đủ thanh toán cho gas * Giá + Giá trị ",
    ...
    PARITY_Old:
        "Nonce quá thấp để tạo một giao dịch, hãy thử lại bằng cách tăng số nonce.",
    PARITY_TooCheapToReplace:
        "Phí giao dịch quá thấp. Đang có một giao dịch khác có cùng số nonce đang bị gián đoạn. Hãy thử lại bằng cách tăng phí giao dịch.",
    PARITY_LimitReached:
        "Có quá nhiều giao dịch đang bị gián đoạn. Giao dịch của bạn sẽ bị ngắt nhằm đảm bảo mức giới hạn an toàn. Hãy thử lại bằng cách tăng phí giao dịch.",
    PARITY_InsufficientGasPrice:
        "Phí giao dịch quá thấp. Nó không đáp ứng được mức phí tối thiểu dành cho node của bạn (Tối thiểu: {}, bạn có: {}). Hãy thử lại bằng cách tăng phí giao dịch.",
    PARITY_InsufficientBalance:
        "Không đủ số dư. Bạn đang cố gắng gửi đi một giao dịch vs số dư bị thiếu. Số dư cần thiết {} và bạn có: {}.",
    PARITY_GasLimitExceeded:
        "Phí giao dịch đang vượt quá mức giới hạn gas hiện tại. Giới hạn: {}, bạn có: {}. Hãy thử lại bằng cách giảm bớt số gas.",
    PARITY_InvalidGasLimit:
        "Tổng số gas mà bạn sử dụng đang vượt mức giới hạn cho phép.",
    ...
    TranslatorAddr_2:
        "https://www.facebook.com/ethereumvietnam https://www.ethereumvn.com ",
    ...
    HELP_Warning:
        "Nếu bạn đã khởi tạo Ví -hoặc- đã tải về máy tập tin có chứa dữ liệu ví trước **Ngày 31 Tháng 12 năm 2015**, xin vui lòng kiễm tra lại dữ liệu Ví; dễ tải về phiên bản mới của tập tin Ví. Chi tiết xem tại. ",
    HELP_Desc:
        "Nếu bạn thấy có gì sai sót và có những câu hỏi nào khác cần được giải đáp. [Xin Liên Lạc Với Chúng Tôi](mailto:support@myetherwallet.com), và chúng tôi sẽ giải đáp những thắc mắc từ bạn, ngoài ra chúng tôi sẽ cập nhật lại trang web nhằm đem lại nhiều tiện lợi nhất có thể cho người sử dụng trong tương lai! ",
    ...
    HELP_0_Desc_4:
        "Xác thực rằng  bạn có quyền truy cập vào ví mới này và hãy chắc chắn đã sao lưu tất cả các thông tin cần thiết. ",
    ...
    HELP_1_Desc_3:
        "Nhập một mật khẩu mạnh. Nếu bạn nghĩ có thể quên mật khẩu thì bạn nên lưu nó lại một nơi nào đó thật an toàn. bạn sẽ cần đến mật khẩu này dễ gửi đi một giao dịch. ",
    ...
    HELP_2a_Desc_2:
        "Lưu lại địa chỉ Ví. Bạn có thể giữ nó cho chính mình hoặc chia sẽ nó cho bất cứ ai. Người khác có thể gửi Ether cho bạn thông qua địa chỉ Ví của bạn. ",
    HELP_2a_Desc_3:
        "Private key. Không được chia sẽ Private key cho bất cứ ai. Private key rất cần thiết khi bạn muốn truy cập vào Ví và Gửi đi một lượng Ether! hiện tại có 3 phiên bản lưu trữ dành cho Private Key: ",
    HELP_2a_Desc_4:
    ...
    HELP_2a_Desc_5:
        "Bạn Có thể in Ví giấy nếu bạn sở hữu máy in. Ngoài ra, bạn có thể ghi lại Private key và địa chỉ Ví của bạn lên một tờ giấy. Hãy Cất giữ chúng tại một nơi an toàn, hãy ngắt kết nối hoàn toàn giữa máy tính và USB của bạn. ",
    HELP_2a_Desc_6:
    ...
    HELP_2b_Desc_6:
        "Lưu giữ lại địa chỉ Ví vừa tạo. Lưu giữ lại các định dạng của Private key. Lưu giữ lại mật khẩu của bạn nếu bạn không hoàn toàn nhớ nó mãi mãi. ",
    HELP_2b_Desc_7:
        "Cất giữ tờ giáy mà bạn đã ghi lên / USB tại nhiều nơi riêng biệt. ",
    HELP_2b_Desc_8:
        'đi đến trang "Xem thông tin Ví" và gõ vào Private key của bạn / mật khẩu nhằm đảm bảo rằng nó hoàn toàn chính xác và truy cập vào Ví. kiễm tra lại mật khẩu mà bạn ghi lại trên giấy có giống nhau hay chưa. ',

    HELP_3_Title:
        "3) Làm thế nào dễ xác minh và truy cập vào Ví mới được khởi tạo? ",
    HELP_3_Desc_1:
    ...
    HELP_3_Desc_3:
        'Bạn hãy đi đến trang MyEtherWallet.com "Xem Thông Tin Ví". ',
    HELP_3_Desc_4:
        "Chọn tập tin định dạng Ví của bạn -hoặc- sử dụng Private key của bạn dễ mở khoá Ví. ",
    HELP_3_Desc_5:
        "Nếu Ví của bạn được mã hoá, ô điền thông tin sẽ tự động báo lại. Nhập mật khẩu. ",
    ...
    HELP_4_Desc_3:
        "Chọn tập tin Ví -hoặc- Private key của bạn dễ mở khoá cho Ví. ",
    HELP_4_Desc_4:
        "Nếu Ví của bạn đang trong tình trạng mã hoá,ô điền thông tin sẽ tự động báo lại. Nhập mật khẩu. ",
    HELP_4_Desc_5: 'Chọn vào nút "Mở Khoá Ví". ',
    HELP_4_Desc_6:
        'Điền địa chỉ mà bạn muốn gửi đến tại khung trống "Địa chỉ đến:". ',
    HELP_4_Desc_7:
        'Điền số lượng Ether mà bạn muốn gửi đi.Hoặc bạn có thể chọn vào phần "Gửi toàn bộ số dư" nếu bạn muốn chuyển đi toàn bộ số Ether mà bạn hiện có trong tài khoản. ',
    HELP_4_Desc_9: 'Chọn vào "Khởi tạo Giao dịch". ',
    HELP_4_Desc_10:
        "Một cửa sổ thông báo sẽ hiện ra. Việc khởi tạo giao dịch này được thực hiện từ trình duyệt của bạn. ",
    ...
    HELP_4CX_Desc_1:
        'Trước tiên, bạn cần phải thêm Ví của bạn vào. Sau khi thực hiện xong, Bạn sẽ có 2 lựa chọn: Chức năng "Gửi Nhanh" từ biểu tượng nằm trên thanh công cụ tiện ích của Google Chrome hoặc chọn vào "Gửi Ether và Tokens" dễ đi đến trang trình duyệt. ',
    HELP_4CX_Desc_2: "Gửi Nhanh ",
    HELP_4CX_Desc_3:
        "Chọn vào biểu tượng trên thanh tiẹn ích của Google Chrome. ",
    ...
    HELP_5_Title:
        "5) Làm thế nào dễ kích hoạt MyEtherWallet.com với tính năng offline? ",
    HELP_5_Desc_1:
    ...
    HELP_5_Desc_7:
        "MyEtherWallet.com sẽ được chạy hoàn toàn trên máy tính của bạn. ",
    HELP_5_Desc_8:
    ...
    HELP_5CX_Title:
        "5) Làm sao dễ chúng tôi có thể cài đặt phần mở rộng từ repo thay vì từ cửa hàng ứng dụng của Chrome? ",
    HELP_5CX_Desc_2: "Chọn vào ô `chrome-extension-vX.X.X.X.zip`. ",
    HELP_5CX_Desc_3:
        "Tại trình duyệt Google Chrome và tìm phần cài đặt của nó (Trong mục menu nằm trên góc phải cửa sổ). ",
    HELP_5CX_Desc_4: 'chọn phần "Extensions" nằm bên trái. ',
    HELP_5CX_Desc_5:
        'kiễm tra lại nút "Developer Mode" nằm trên cùng của trang. ',
    HELP_5CX_Desc_6: 'Chọn vào ô "Load unpacked extension...". ',
    HELP_5CX_Desc_7:
        'Đưa chuột và chọn vào tập tin mà bạn vừa tải về và giải nén nó trước đó, nhấp vào nút "Select". ',
    HELP_5CX_Desc_8:
        "Ứng dụng mở rộng không nên cho xuất hiện tại mục mở rộng và thanh ứng dụng mở rộng tại Google Chrome. ",
    ...
    HELP_7_Desc_3:
        'Điền địa chỉ mà bạn cần gửi đến tại ô trống "Địa chỉ đến:" . ',
    HELP_7_Desc_4: "Điền số lượng Token mà bạn muốn gửi. ",
    HELP_7_Desc_5: "Chọn loại Token mà bạn muốn gửi đi. ",
    HELP_7_Desc_6:
        "Nếu bạn không thấy Token của bạn hiển thị trên trang chúng tôi: ",
    HELP_7_Desc_7: 'Chọn vào "Custom". ',
    HELP_7_Desc_8:
        'Điền địa chỉ, tên, đơn vị số thập phân của loại Token mà bạn muốn. Chúng được cung cấp bởi các nhà phát triển Token và nó cũng cần thiết khi bạn "thêm vào dễ xem Token" trên Mist. ',
    HELP_7_Desc_9: 'Chọn "Lưu". ',
    HELP_7_Desc_10:
        "Bạn có thể gửi token cũng như bạn sẽ nhìn thấy số dư của nó nằm ở khung bên cạnh. ",
    HELP_7_Desc_11: 'Chọn "Khởi tạo giao dịch". ',
    HELP_7_Desc_12:
        "Một thông báo sẽ xuất hiện và xác thực rằng đây là việc khởi tạo giao dịch từ trình duyệt của bạn. ",
    HELP_7_Desc_13: 'Chọn vào nút màu xanh phía dưới "Gửi giao dịch đi". ',
    HELP_7_Desc_14:
        'Sau đó một thông báo sẽ xuất hiện. Xác thực lại số lượng Ether và địa chỉ đến. sau đó nhấn vào nút  "Có, Tôi chắc chắn! Hãy thực hiện giao dịch.". ',
    HELP_7_Desc_15:
        "Giao dịch của bạn sẽ được Thực hiện. TXid sẽ hiển thị cho bạn. Bạn có thể chọn vào TXid và nhìn ấy giao dịch của bạn trên blockchain. ",
    ...
    HELP_8CX_Desc_3:
        "Nếu vì một lý do bất kì buộc MyEtherWallet CX không tồn tại trên kho tiện ích của Chrome, bạn có thể tìm thấy mã nguồn trên Github và tải về máy của bạn. Xem phần #5 ở trên. ",
    ...
    HELP_10_Desc_1:
        'Đi đến trang "Giao dịch Offline" thông qua máy tính đang online. ',
    HELP_10_Desc_2:
        'Điền vào "Địa chỉ gửi". Lưu ý, đây là địa chỉ mà bạn dùng dễ gửi, không phải là địa chỉ đến. và nó sẽ khởi tạo nonce và xác định giá Gas hiện tại. ',
    HELP_10_Desc_3:
        'Sau đó, chuyển đến máy tính Offline của bạn. Điền vào "Địa chỉ đến" và "Số cần gửi" mà bạn muốn gửi đi. ',
    HELP_10_Desc_4:
        'Điền vào "Giá Gas" được hiển thị trên máy tính online của bạn ở bước #1. ',
    HELP_10_Desc_5:
        'Điền vào "NONCE" được hiển thị trên máy tính online của bạn ở bước #1. ',
    HELP_10_Desc_6:
        'Sau đó "Giới hạn GAS" sẽ được mặc định với số gas là 21000. Điều này sẽ khởi tạo một giao dịch thông thường. Nếu bạn gửi đi một hợp đồng hoặc bổ sung thêm dữ liệu vối với giao dịch của bạn, bạn cần phải tăng lên số Giới hạn gas và bất kì gas dư thừa sẽ được hoàn trả lại cho bạn. ',
    HELP_10_Desc_7:
        "Nếu bạn muốn, Thêm vào một số dữ liệu. Nếu bạn điền dữ liệu vào, bạn sẽ cần số Giới hạn gas nhiều hơn số 21000 được mạc định ban đầu. Tất cả dữ liệu đều ở định dạng HEX . ",
    HELP_10_Desc_8:
        "Chọn tập tin Ví của bạn -hoặc- Private key của bạn dễ mở khoá Ví. ",
    HELP_10_Desc_9: 'nhấn vào nút "Khởi tạo Chữ Ký cho giao dịch". ',
    HELP_10_Desc_10:
        "Các trường dữ liệu phía dưới nút này sẽ dùng dễ chứng thực chữ ký cho giao dịch của bạn. Cóp hết đoạn dữ liệu này và chuyển đến máy tính online của bạn. ",
    HELP_10_Desc_11:
        'Trên máy tính online của bạn, bạn hãy dán chữ ký giao dịch vào khung điền văn bản tại bước #3 và chọn nút "Gửi Ether". Việc làm này sẽ phát sóng đi giao dịch của bạn. ',

    HELP_12_Title:
        "12) Làm thế nào dễ tôi sử dụng Ví được khởi tạo từ MyEtherWallet trên geth / Ví Ethereum / Mist? ",
    HELP_12_Desc_1:
    ...
    HELP_12_Desc_3:
        "Mở khoá Ví và sử dụng định dạng **mã hoá** private key của bạn hoặc tập tin chứa định dạng JSON. ",
    HELP_12_Desc_4: 'Đi đến trang "Ví Của Tôi". ',
    HELP_12_Desc_5:
        'Chọn Ví mà bạn muốn dùng dễ sử dụng trên Mist, chon vào biểu tượng "Xem", Điền mật khẩu của bạn, và đăng nhập vào Ví của bạn. ',
    HELP_12_Desc_6:
        'Tìm phần "Tải về định dạng JSON - định dạng Geth/Mist (Mã hoá)". Nhấn vào nút "Tải về máy" nằm phía dưới. Bây giờ bạn đã sở hữu định dạng Keystone. ',
    HELP_12_Desc_7: "Truy cập Ví trên ứng dụng Ví Ethereum. ",
    HELP_12_Desc_8:
        'Tại thanh Menu, bạn chọn như sau "Accounts" -> "Backup" -> "Accounts" ',
    HELP_12_Desc_9:
        "Bạn sẽ mở thư mục keystore của bạn ra. Sao chép tập tin mà bạn đã tải về máy (`UTC--2016-04-14......../`) vào trong thư mục keystone. ",
    HELP_12_Desc_10:
        'Tài khoản của bạn sẽ hiển thị ngay dưới phần "Accounts." ',
    HELP_12_Desc_11: "Sử dụng Private key không mã hóa của bạn... ",
    HELP_12_Desc_12:
        'Nếu bạn chưa sở hữu private key không mã hoá , hãy đi đến trang "Xem thông tin Ví". ',
    HELP_12_Desc_13:
        "Chọn tập tin Ví của bạn -hoặc- Private key của bạn dễ mở khoá Ví. ",
    ...
    HELP_14_Title:
        "14) Một số trang khi khởi tạo Private key thông qua việc di chuyển con trỏ chuột máy tính trên màn hình. MyEtherWallet.com không làm theo cách này. Các ký tự Private key được tạo ra trên trang MyEtherWallet một cách an toàn nhất? ",
    HELP_14_Desc_1:
    ...
    HELP_15_Title:
        "15) Vì sao tài khoản của tôi vừa tạo lại không tồn tại trên Blockchain Explorer? (bao gồm: etherchain, etherscan) ",
    HELP_15_Desc_1:
    ...
    HELP_21_Title:
        "21) có thể xảy ra trường hợp có một cá nhân nào đó sử dụng ngẫu nhiên một Private key dễ thấy được số dư tài khoản của một người khác và chuyển số Ether đó vào địa chỉ mà cá nhân dó sở hữu hay không? ",
    HELP_21_Desc_1:
    ...
    HELP_SecCX_Desc_1:
        "Những thông tin dữ liệu được kho tiện ích lưu trữ ở đâu? ",
    HELP_SecCX_Desc_2:
        "Các thông tin dữ liệu được lưu trữ tại kho tiện ích của trình duyệt Chrome thông qua [chrome.storage](http://chrome.storage/). - Đây cũng là nơi mà mật khẩu của bạn được lưu trữ khi bạn chọn cài đặt lưu lại mật khẩu ở trình duyệt Chrome. ",
    HELP_SecCX_Desc_3: "Những loại thông tin nào sẽ được lưu trữ? ",
    HELP_SecCX_Desc_4:
        "Địa chỉ, tên gọi và Private key sẽ được lưu trữ tại chrome.storage. Private key sẽ được mã hoá và sử dụng mật khẩu mà bạn thiết lập trong lúc bạn đang thực hiện thêm Ví nhưng địa chỉ Ví và tên Ví thì không bị mã hoá. ",
    HELP_SecCX_Desc_5: "Vì sao địa chỉ và tên gọi lại không cần thiết mã hoá? ",
    HELP_SecCX_Desc_6:
        "Nếu chúng tôi mã hoá chúng, thì bạn phải điền mật khẩu khi bạn muốn xem số dư hiện tại của tài khoản bạn và xem tên gọi của tài khoản đó. Nếu như bạn cảm thấy đáp ứng nhu cầu bạn đã nêu, Chúng tôi cung cấp thêm lựa chọn khác dành cho bạn đó là MyEtherWallet.com thay vì phải sử dụng Chrome Extension. ",
